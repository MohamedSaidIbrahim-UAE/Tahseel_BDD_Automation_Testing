/**
 * Step Definitions for Detailed Transactions report by revenue entity Module
 *
 * This file contains all step definitions for the Detailed Transactions report by revenue entity feature.
 * Steps are organized by type: Given, When, Then
 *
 * @category Step Definitions
 * @module detailed-transactions-report-by-revenue-entity.steps
 */

import { Given, When, Then, DataTable } from '@cucumber/cucumber';
import { Page, expect } from '@playwright/test';
import { DetailedTransactionsReportByRevenueEntity } from '../pages/generated/detailed-transactions-report-by-revenue-entity.page';
 ...
 */
let page: Page;
let detailedTransactionsReportByRevenueEntity: DetailedTransactionsReportByRevenueEntity;
...
function initializePageObject(): void {
  ...
  detailedTransactionsReportByRevenueEntity = new DetailedTransactionsReportByRevenueEntity(page);
}
...
Given('the user navigates to the "{string}" module', async (moduleName: string) => {
  ...
  await detailedTransactionsReportByRevenueEntity.navigateToModule();
});
...
Given('the module page is loaded', async () => {
  initializePageObject();
  await detailedTransactionsReportByRevenueEntity.verifyPageLoaded();
});
...
Given('the form is open', async () => {
  initializePageObject();
  await detailedTransactionsReportByRevenueEntity.verifyFormVisible();
});
...
Given('the user fills the form with the following data:', async (dataTable: DataTable) => {
  ...
  for (const [fieldName, fieldValue] of Object.entries(data)) {
    await detailedTransactionsReportByRevenueEntity.fillField(fieldName, fieldValue);
  }
});
...
When('the user searches for "{string}"', async (searchTerm: string) => {
  initializePageObject();
  await detailedTransactionsReportByRevenueEntity.searchTable(searchTerm);
});
...
When('the user clicks the export button', async () => {
  initializePageObject();
  await detailedTransactionsReportByRevenueEntity.exportData();
});
...
When('the user submits the form', async () => {
  initializePageObject();
  await detailedTransactionsReportByRevenueEntity.submitForm();
});
...
Then('all main elements should be visible', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    detailedTransactionsReportByRevenueEntity.selectors.mainContainer as string
  );
});
...
Then('the table should contain at least one row', async () => {
  initializePageObject();
  await detailedTransactionsReportByRevenueEntity.verifyTableHasData();
});
...
Then('the success message should be displayed', async () => {
  initializePageObject();
  await detailedTransactionsReportByRevenueEntity.verifySuccessMessage();
});
...
Then('the form should close', async () => {
  initializePageObject();
  await detailedTransactionsReportByRevenueEntity.verifyFormClosed();
});
...
Then('the validation error should be displayed', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    detailedTransactionsReportByRevenueEntity.selectors.errorMessage as string
  );
});
...
Then('the submit button should be enabled', async () => {
  ...
  await AssertionHelpers.assertElementEnabled(
    page,
    detailedTransactionsReportByRevenueEntity.selectors.submitButton as string
  );
});
