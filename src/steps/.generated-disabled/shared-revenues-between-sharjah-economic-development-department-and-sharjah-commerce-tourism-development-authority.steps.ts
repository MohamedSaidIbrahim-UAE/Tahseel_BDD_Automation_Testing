/**
 * Step Definitions for Shared revenues between Sharjah Economic Development Department and Sharjah Commerce & Tourism Development Authority Module
 *
 * This file contains all step definitions for the Shared revenues between Sharjah Economic Development Department and Sharjah Commerce & Tourism Development Authority feature.
 * Steps are organized by type: Given, When, Then
 *
 * @category Step Definitions
 * @module shared-revenues-between-sharjah-economic-development-department-and-sharjah-commerce-tourism-development-authority.steps
 */

import { Given, When, Then, DataTable } from '@cucumber/cucumber';
import { Page, expect } from '@playwright/test';
import { SharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority } from '../pages/generated/shared-revenues-between-sharjah-economic-development-department-and-sharjah-commerce-tourism-development-authority.page';
 ...
 */
let page: Page;
let sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority: SharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority;
...
function initializePageObject(): void {
  ...
  sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority = new SharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority(page);
}
...
Given('the user navigates to the "{string}" module', async (moduleName: string) => {
  ...
  await sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.navigateToModule();
});
...
Given('the module page is loaded', async () => {
  initializePageObject();
  await sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.verifyPageLoaded();
});
...
Given('the form is open', async () => {
  initializePageObject();
  await sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.verifyFormVisible();
});
...
Given('the user fills the form with the following data:', async (dataTable: DataTable) => {
  ...
  for (const [fieldName, fieldValue] of Object.entries(data)) {
    await sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.fillField(fieldName, fieldValue);
  }
});
...
When('the user searches for "{string}"', async (searchTerm: string) => {
  initializePageObject();
  await sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.searchTable(searchTerm);
});
...
When('the user clicks the export button', async () => {
  initializePageObject();
  await sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.exportData();
});
...
When('the user submits the form', async () => {
  initializePageObject();
  await sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.submitForm();
});
...
Then('all main elements should be visible', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.selectors.mainContainer as string
  );
});
...
Then('the table should contain at least one row', async () => {
  initializePageObject();
  await sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.verifyTableHasData();
});
...
Then('the success message should be displayed', async () => {
  initializePageObject();
  await sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.verifySuccessMessage();
});
...
Then('the form should close', async () => {
  initializePageObject();
  await sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.verifyFormClosed();
});
...
Then('the validation error should be displayed', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.selectors.errorMessage as string
  );
});
...
Then('the submit button should be enabled', async () => {
  ...
  await AssertionHelpers.assertElementEnabled(
    page,
    sharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority.selectors.submitButton as string
  );
});
