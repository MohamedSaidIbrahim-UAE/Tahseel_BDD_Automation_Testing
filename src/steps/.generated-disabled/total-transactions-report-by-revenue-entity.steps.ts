/**
 * Step Definitions for Total Transactions report by revenue entity Module
 *
 * This file contains all step definitions for the Total Transactions report by revenue entity feature.
 * Steps are organized by type: Given, When, Then
 *
 * @category Step Definitions
 * @module total-transactions-report-by-revenue-entity.steps
 */

import { Given, When, Then, DataTable } from '@cucumber/cucumber';
import { Page, expect } from '@playwright/test';
import { TotalTransactionsReportByRevenueEntity } from '../pages/generated/total-transactions-report-by-revenue-entity.page';
 ...
 */
let page: Page;
let totalTransactionsReportByRevenueEntity: TotalTransactionsReportByRevenueEntity;
...
function initializePageObject(): void {
  ...
  totalTransactionsReportByRevenueEntity = new TotalTransactionsReportByRevenueEntity(page);
}
...
Given('the user navigates to the "{string}" module', async (moduleName: string) => {
  ...
  await totalTransactionsReportByRevenueEntity.navigateToModule();
});
...
Given('the module page is loaded', async () => {
  initializePageObject();
  await totalTransactionsReportByRevenueEntity.verifyPageLoaded();
});
...
Given('the form is open', async () => {
  initializePageObject();
  await totalTransactionsReportByRevenueEntity.verifyFormVisible();
});
...
Given('the user fills the form with the following data:', async (dataTable: DataTable) => {
  ...
  for (const [fieldName, fieldValue] of Object.entries(data)) {
    await totalTransactionsReportByRevenueEntity.fillField(fieldName, fieldValue);
  }
});
...
When('the user searches for "{string}"', async (searchTerm: string) => {
  initializePageObject();
  await totalTransactionsReportByRevenueEntity.searchTable(searchTerm);
});
...
When('the user clicks the export button', async () => {
  initializePageObject();
  await totalTransactionsReportByRevenueEntity.exportData();
});
...
When('the user submits the form', async () => {
  initializePageObject();
  await totalTransactionsReportByRevenueEntity.submitForm();
});
...
Then('all main elements should be visible', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    totalTransactionsReportByRevenueEntity.selectors.mainContainer as string
  );
});
...
Then('the table should contain at least one row', async () => {
  initializePageObject();
  await totalTransactionsReportByRevenueEntity.verifyTableHasData();
});
...
Then('the success message should be displayed', async () => {
  initializePageObject();
  await totalTransactionsReportByRevenueEntity.verifySuccessMessage();
});
...
Then('the form should close', async () => {
  initializePageObject();
  await totalTransactionsReportByRevenueEntity.verifyFormClosed();
});
...
Then('the validation error should be displayed', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    totalTransactionsReportByRevenueEntity.selectors.errorMessage as string
  );
});
...
Then('the submit button should be enabled', async () => {
  ...
  await AssertionHelpers.assertElementEnabled(
    page,
    totalTransactionsReportByRevenueEntity.selectors.submitButton as string
  );
});
