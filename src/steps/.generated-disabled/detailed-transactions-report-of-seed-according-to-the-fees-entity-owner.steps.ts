/**
 * Step Definitions for Detailed transactions report of SEED According to the Fees entity owner Module
 *
 * This file contains all step definitions for the Detailed transactions report of SEED According to the Fees entity owner feature.
 * Steps are organized by type: Given, When, Then
 *
 * @category Step Definitions
 * @module detailed-transactions-report-of-seed-according-to-the-fees-entity-owner.steps
 */

import { Given, When, Then, DataTable } from '@cucumber/cucumber';
import { Page, expect } from '@playwright/test';
import { DetailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner } from '../pages/generated/detailed-transactions-report-of-seed-according-to-the-fees-entity-owner.page';
 ...
 */
let page: Page;
let detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner: DetailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner;
...
function initializePageObject(): void {
  ...
  detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner = new DetailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner(page);
}
...
Given('the user navigates to the "{string}" module', async (moduleName: string) => {
  ...
  await detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.navigateToModule();
});
...
Given('the module page is loaded', async () => {
  initializePageObject();
  await detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.verifyPageLoaded();
});
...
Given('the form is open', async () => {
  initializePageObject();
  await detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.verifyFormVisible();
});
...
Given('the user fills the form with the following data:', async (dataTable: DataTable) => {
  ...
  for (const [fieldName, fieldValue] of Object.entries(data)) {
    await detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.fillField(fieldName, fieldValue);
  }
});
...
When('the user searches for "{string}"', async (searchTerm: string) => {
  initializePageObject();
  await detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.searchTable(searchTerm);
});
...
When('the user clicks the export button', async () => {
  initializePageObject();
  await detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.exportData();
});
...
When('the user submits the form', async () => {
  initializePageObject();
  await detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.submitForm();
});
...
Then('all main elements should be visible', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.selectors.mainContainer as string
  );
});
...
Then('the table should contain at least one row', async () => {
  initializePageObject();
  await detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.verifyTableHasData();
});
...
Then('the success message should be displayed', async () => {
  initializePageObject();
  await detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.verifySuccessMessage();
});
...
Then('the form should close', async () => {
  initializePageObject();
  await detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.verifyFormClosed();
});
...
Then('the validation error should be displayed', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.selectors.errorMessage as string
  );
});
...
Then('the submit button should be enabled', async () => {
  ...
  await AssertionHelpers.assertElementEnabled(
    page,
    detailedTransactionsReportOfSeedAccordingToTheFeesEntityOwner.selectors.submitButton as string
  );
});
