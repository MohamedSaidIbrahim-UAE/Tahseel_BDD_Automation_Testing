/**
 * Step Definitions for Collectors performance report for transactions completed from the direct payment Module
 *
 * This file contains all step definitions for the Collectors performance report for transactions completed from the direct payment feature.
 * Steps are organized by type: Given, When, Then
 *
 * @category Step Definitions
 * @module collectors-performance-report-for-transactions-completed-from-the-direct-payment.steps
 */

import { Given, When, Then, DataTable } from '@cucumber/cucumber';
import { Page, expect } from '@playwright/test';
import { CollectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment } from '../pages/generated/collectors-performance-report-for-transactions-completed-from-the-direct-payment.page';
 ...
 */
let page: Page;
let collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment: CollectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment;
...
function initializePageObject(): void {
  ...
  collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment = new CollectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment(page);
}
...
Given('the user navigates to the "{string}" module', async (moduleName: string) => {
  ...
  await collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.navigateToModule();
});
...
Given('the module page is loaded', async () => {
  initializePageObject();
  await collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.verifyPageLoaded();
});
...
Given('the form is open', async () => {
  initializePageObject();
  await collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.verifyFormVisible();
});
...
Given('the user fills the form with the following data:', async (dataTable: DataTable) => {
  ...
  for (const [fieldName, fieldValue] of Object.entries(data)) {
    await collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.fillField(fieldName, fieldValue);
  }
});
...
When('the user searches for "{string}"', async (searchTerm: string) => {
  initializePageObject();
  await collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.searchTable(searchTerm);
});
...
When('the user clicks the export button', async () => {
  initializePageObject();
  await collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.exportData();
});
...
When('the user submits the form', async () => {
  initializePageObject();
  await collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.submitForm();
});
...
Then('all main elements should be visible', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.selectors.mainContainer as string
  );
});
...
Then('the table should contain at least one row', async () => {
  initializePageObject();
  await collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.verifyTableHasData();
});
...
Then('the success message should be displayed', async () => {
  initializePageObject();
  await collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.verifySuccessMessage();
});
...
Then('the form should close', async () => {
  initializePageObject();
  await collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.verifyFormClosed();
});
...
Then('the validation error should be displayed', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.selectors.errorMessage as string
  );
});
...
Then('the submit button should be enabled', async () => {
  ...
  await AssertionHelpers.assertElementEnabled(
    page,
    collectorsPerformanceReportForTransactionsCompletedFromTheDirectPayment.selectors.submitButton as string
  );
});
