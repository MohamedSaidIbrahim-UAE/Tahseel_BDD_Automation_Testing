/**
 * Step Definitions for Aggregated transactions report of SEDD According to the Fees entity owner Module
 *
 * This file contains all step definitions for the Aggregated transactions report of SEDD According to the Fees entity owner feature.
 * Steps are organized by type: Given, When, Then
 *
 * @category Step Definitions
 * @module aggregated-transactions-report-of-sedd-according-to-the-fees-entity-owner.steps
 */

import { Given, When, Then, DataTable } from '@cucumber/cucumber';
import { Page, expect } from '@playwright/test';
import { AggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner } from '../pages/generated/aggregated-transactions-report-of-sedd-according-to-the-fees-entity-owner.page';
 ...
 */
let page: Page;
let aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner: AggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner;
...
function initializePageObject(): void {
  ...
  aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner = new AggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner(page);
}
...
Given('the user navigates to the "{string}" module', async (moduleName: string) => {
  ...
  await aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.navigateToModule();
});
...
Given('the module page is loaded', async () => {
  initializePageObject();
  await aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.verifyPageLoaded();
});
...
Given('the form is open', async () => {
  initializePageObject();
  await aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.verifyFormVisible();
});
...
Given('the user fills the form with the following data:', async (dataTable: DataTable) => {
  ...
  for (const [fieldName, fieldValue] of Object.entries(data)) {
    await aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.fillField(fieldName, fieldValue);
  }
});
...
When('the user searches for "{string}"', async (searchTerm: string) => {
  initializePageObject();
  await aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.searchTable(searchTerm);
});
...
When('the user clicks the export button', async () => {
  initializePageObject();
  await aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.exportData();
});
...
When('the user submits the form', async () => {
  initializePageObject();
  await aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.submitForm();
});
...
Then('all main elements should be visible', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.selectors.mainContainer as string
  );
});
...
Then('the table should contain at least one row', async () => {
  initializePageObject();
  await aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.verifyTableHasData();
});
...
Then('the success message should be displayed', async () => {
  initializePageObject();
  await aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.verifySuccessMessage();
});
...
Then('the form should close', async () => {
  initializePageObject();
  await aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.verifyFormClosed();
});
...
Then('the validation error should be displayed', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.selectors.errorMessage as string
  );
});
...
Then('the submit button should be enabled', async () => {
  ...
  await AssertionHelpers.assertElementEnabled(
    page,
    aggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner.selectors.submitButton as string
  );
});
