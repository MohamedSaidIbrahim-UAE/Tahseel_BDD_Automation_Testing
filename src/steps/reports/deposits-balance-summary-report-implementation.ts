...
export class DepositsBalanceSummaryReportSteps extends ReportStepDefinitions {
  constructor(world: World) { super(world); this.moduleName = 'Deposits Balance Summary Report'; }
