...
export class DetailedChequesReportRevenuesSteps extends ReportStepDefinitions {
  constructor(world: World) { super(world); this.moduleName = 'Detailed Cheques Report Revenues'; }
