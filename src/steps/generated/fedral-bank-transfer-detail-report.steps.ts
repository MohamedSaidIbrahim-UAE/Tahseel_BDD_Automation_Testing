/**
 * Step Definitions for Fedral Bank Transfer Detail Report Module
 *
 * This file contains all step definitions for the Fedral Bank Transfer Detail Report feature.
 * Steps are organized by type: Given, When, Then
 *
 * @category Step Definitions
 * @module fedral-bank-transfer-detail-report.steps
 */

import { Given, When, Then, DataTable } from '@cucumber/cucumber';
import { Page, expect } from '@playwright/test';
import { FedralBankTransferDetailReport } from '../pages/generated/fedral-bank-transfer-detail-report.page';
 ...
 */
let page: Page;
let fedralBankTransferDetailReport: FedralBankTransferDetailReport;
...
function initializePageObject(): void {
  ...
  fedralBankTransferDetailReport = new FedralBankTransferDetailReport(page);
}
...
Given('the user navigates to the "{string}" module', async (moduleName: string) => {
  ...
  await fedralBankTransferDetailReport.navigateToModule();
});
...
Given('the module page is loaded', async () => {
  initializePageObject();
  await fedralBankTransferDetailReport.verifyPageLoaded();
});
...
Given('the form is open', async () => {
  initializePageObject();
  await fedralBankTransferDetailReport.verifyFormVisible();
});
...
Given('the user fills the form with the following data:', async (dataTable: DataTable) => {
  ...
  for (const [fieldName, fieldValue] of Object.entries(data)) {
    await fedralBankTransferDetailReport.fillField(fieldName, fieldValue);
  }
});
...
When('the user searches for "{string}"', async (searchTerm: string) => {
  initializePageObject();
  await fedralBankTransferDetailReport.searchTable(searchTerm);
});
...
When('the user clicks the export button', async () => {
  initializePageObject();
  await fedralBankTransferDetailReport.exportData();
});
...
When('the user submits the form', async () => {
  initializePageObject();
  await fedralBankTransferDetailReport.submitForm();
});
...
Then('all main elements should be visible', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    fedralBankTransferDetailReport.selectors.mainContainer as string
  );
});
...
Then('the table should contain at least one row', async () => {
  initializePageObject();
  await fedralBankTransferDetailReport.verifyTableHasData();
});
...
Then('the success message should be displayed', async () => {
  initializePageObject();
  await fedralBankTransferDetailReport.verifySuccessMessage();
});
...
Then('the form should close', async () => {
  initializePageObject();
  await fedralBankTransferDetailReport.verifyFormClosed();
});
...
Then('the validation error should be displayed', async () => {
  ...
  await AssertionHelpers.assertElementVisible(
    page,
    fedralBankTransferDetailReport.selectors.errorMessage as string
  );
});
...
Then('the submit button should be enabled', async () => {
  ...
  await AssertionHelpers.assertElementEnabled(
    page,
    fedralBankTransferDetailReport.selectors.submitButton as string
  );
});
