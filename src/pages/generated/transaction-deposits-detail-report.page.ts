/**
 * TransactionDepositsDetailReport Page Object Model
 * 
 * Module: Transaction deposits detail Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/03ab3eab-c98d-44ec-81e1-2d35d11fa147
 * 
 * This POM class encapsulates all interactions with the Transaction deposits detail Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TransactionDepositsDetailReport
 */
...
/**
 * TransactionDepositsDetailReport
 * 
 * Provides page object methods for Transaction deposits detail Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new TransactionDepositsDetailReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TransactionDepositsDetailReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Transaction deposits detail Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/03ab3eab-c98d-44ec-81e1-2d35d11fa147';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/03ab3eab-c98d-44ec-81e1-2d35d11fa147');
  }
