/**
 * AdjustmentRegistrationRequest Page Object Model
 * 
 * Module: Adjustment Registration Request
 * URL: https://staging.tahseel.gov.ae/ManagePortal/adjustment-registeration/request-register-adjustment
 * 
 * This POM class encapsulates all interactions with the Adjustment Registration Request module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module AdjustmentRegistrationRequest
 */
...
/**
 * AdjustmentRegistrationRequest
 * 
 * Provides page object methods for Adjustment Registration Request module.
 * 
 * Usage:
 * ```typescript
 * const page = new AdjustmentRegistrationRequest(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class AdjustmentRegistrationRequest extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Adjustment Registration Request';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/adjustment-registeration/request-register-adjustment';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/adjustment-registeration/request-register-adjustment');
  }
