/**
 * PreAuthorizedTransactionWorkflow Page Object Model
 * 
 * Module: Pre-Authorized Transaction Workflow
 * URL: https://staging.tahseel.gov.ae/ManagePortal/workflowManag/pre-authorized-transactions-workflow
 * 
 * This POM class encapsulates all interactions with the Pre-Authorized Transaction Workflow module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module PreAuthorizedTransactionWorkflow
 */
...
/**
 * PreAuthorizedTransactionWorkflow
 * 
 * Provides page object methods for Pre-Authorized Transaction Workflow module.
 * 
 * Usage:
 * ```typescript
 * const page = new PreAuthorizedTransactionWorkflow(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class PreAuthorizedTransactionWorkflow extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Pre-Authorized Transaction Workflow';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/workflowManag/pre-authorized-transactions-workflow');
  }
