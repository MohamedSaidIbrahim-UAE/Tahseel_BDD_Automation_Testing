/**
 * SecurityScopes Page Object Model
 * 
 * Module: Security Scopes
 * URL: https://staging.tahseel.gov.ae/ManagePortal/scope
 * 
 * This POM class encapsulates all interactions with the Security Scopes module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SecurityScopes
 */
 ...
 * SecurityScopes
 * 
 * Provides page object methods for Security Scopes module.
 * 
 * Usage:
 * ```typescript
 * const page = new SecurityScopes(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SecurityScopes extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Security Scopes';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/scope';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/scope');
  }
