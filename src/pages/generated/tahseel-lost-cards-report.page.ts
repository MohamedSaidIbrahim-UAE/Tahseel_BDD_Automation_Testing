/**
 * TahseelLostCardsReport Page Object Model
 * 
 * Module: Tahseel Lost Cards Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/c0d4e042-e2be-479a-9f1a-c8fdf4ea726b
 * 
 * This POM class encapsulates all interactions with the Tahseel Lost Cards Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TahseelLostCardsReport
 */
...
/**
 * TahseelLostCardsReport
 * 
 * Provides page object methods for Tahseel Lost Cards Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new TahseelLostCardsReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TahseelLostCardsReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Tahseel Lost Cards Report';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/c0d4e042-e2be-479a-9f1a-c8fdf4ea726b');
  }
