/**
 * SharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority Page Object Model
 * 
 * Module: Shared revenues between Sharjah Economic Development Department and Sharjah Commerce & Tourism Development Authority
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/3e0d0599-aebe-42db-a03f-aad0ff65c283
 * 
 * This POM class encapsulates all interactions with the Shared revenues between Sharjah Economic Development Department and Sharjah Commerce & Tourism Development Authority module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority
 */
...
/**
 * SharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority
 * 
 * Provides page object methods for Shared revenues between Sharjah Economic Development Department and Sharjah Commerce & Tourism Development Authority module.
 * 
 * Usage:
 * ```typescript
 * const page = new SharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SharedRevenuesBetweenSharjahEconomicDevelopmentDepartmentAndSharjahCommerceTourismDevelopmentAuthority extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Shared revenues between Sharjah Economic Development Department and Sharjah Commerce & Tourism Development Authority';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/3e0d0599-aebe-42db-a03f-aad0ff65c283';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/3e0d0599-aebe-42db-a03f-aad0ff65c283');
  }
