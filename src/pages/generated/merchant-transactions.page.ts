/**
 * MerchantTransactions Page Object Model
 * 
 * Module: Merchant Transactions
 * URL: https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/5
 * 
 * This POM class encapsulates all interactions with the Merchant Transactions module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module MerchantTransactions
 */
 ...
 * 
 * Provides page object methods for Merchant Transactions module.
 * 
 * Usage:
 * ```typescript
 * const page = new MerchantTransactions(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class MerchantTransactions extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Merchant Transactions';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/5';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/5');
  }
