/**
 * EntityServicesAnalysis Page Object Model
 * 
 * Module: Entity Services Analysis
 * URL: https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/4
 * 
 * This POM class encapsulates all interactions with the Entity Services Analysis module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module EntityServicesAnalysis
 */
...
/**
 * EntityServicesAnalysis
 * 
 * Provides page object methods for Entity Services Analysis module.
 * 
 * Usage:
 * ```typescript
 * const page = new EntityServicesAnalysis(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class EntityServicesAnalysis extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Entity Services Analysis';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/4';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/4');
  }
