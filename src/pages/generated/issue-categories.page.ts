/**
 * IssueCategories Page Object Model
 * 
 * Module: Issue Categories
 * URL: https://staging.tahseel.gov.ae/ManagePortal/issue/issue-category-management
 * 
 * This POM class encapsulates all interactions with the Issue Categories module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module IssueCategories
 */
 ...
 * IssueCategories
 * 
 * Provides page object methods for Issue Categories module.
 * 
 * Usage:
 * ```typescript
 * const page = new IssueCategories(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class IssueCategories extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Issue Categories';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/issue/issue-category-management';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/issue/issue-category-management');
  }
