/**
 * CancelledRefundRequests Page Object Model
 * 
 * Module: Cancelled Refund Requests
 * URL: https://staging.tahseel.gov.ae/ManagePortal/refund/cancelled-requests
 * 
 * This POM class encapsulates all interactions with the Cancelled Refund Requests module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module CancelledRefundRequests
 */
...
/**
 * CancelledRefundRequests
 * 
 * Provides page object methods for Cancelled Refund Requests module.
 * 
 * Usage:
 * ```typescript
 * const page = new CancelledRefundRequests(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class CancelledRefundRequests extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Cancelled Refund Requests';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/refund/cancelled-requests';

  readonly selectors: Record<string, string> = {
    mainContainer: '[data-module], main, [role="main"]',
    // Form fields
    inquire_refund_requestsField: '[aria-label="Inquire Refund Requests"], label:has-text("Inquire Refund Requests") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/refund/cancelled-requests');
  }
