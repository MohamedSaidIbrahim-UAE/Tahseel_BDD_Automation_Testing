/**
 * IssueTrackingDetailReport Page Object Model
 * 
 * Module: Issue tracking detail report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/02c677f8-7c17-4073-b7a9-a191416aaed3
 * 
 * This POM class encapsulates all interactions with the Issue tracking detail report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module IssueTrackingDetailReport
 */
...
/**
 * IssueTrackingDetailReport
 * 
 * Provides page object methods for Issue tracking detail report module.
 * 
 * Usage:
 * ```typescript
 * const page = new IssueTrackingDetailReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class IssueTrackingDetailReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Issue tracking detail report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/02c677f8-7c17-4073-b7a9-a191416aaed3';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/02c677f8-7c17-4073-b7a9-a191416aaed3');
  }
