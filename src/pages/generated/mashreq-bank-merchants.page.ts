/**
 * MashreqBankMerchants Page Object Model
 * 
 * Module: Mashreq Bank Merchants
 * URL: https://staging.tahseel.gov.ae/ManagePortal/bank-merchants/mashreq-bank-merchants
 * 
 * This POM class encapsulates all interactions with the Mashreq Bank Merchants module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module MashreqBankMerchants
 */
...
/**
 * MashreqBankMerchants
 * 
 * Provides page object methods for Mashreq Bank Merchants module.
 * 
 * Usage:
 * ```typescript
 * const page = new MashreqBankMerchants(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class MashreqBankMerchants extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Mashreq Bank Merchants';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/bank-merchants/mashreq-bank-merchants';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/bank-merchants/mashreq-bank-merchants');
  }
