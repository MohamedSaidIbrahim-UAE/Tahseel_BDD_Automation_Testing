/**
 * TransactionsDetails Page Object Model
 * 
 * Module: Transactions Details
 * URL: https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/2
 * 
 * This POM class encapsulates all interactions with the Transactions Details module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TransactionsDetails
 */
 ...
 * TransactionsDetails
 * 
 * Provides page object methods for Transactions Details module.
 * 
 * Usage:
 * ```typescript
 * const page = new TransactionsDetails(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TransactionsDetails extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Transactions Details';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/2';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/2');
  }
