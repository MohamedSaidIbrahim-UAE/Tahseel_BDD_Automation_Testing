/**
 * LoginReport Page Object Model
 * 
 * Module: Login Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/30821f51-598a-4f48-911e-e624bb39a377
 * 
 * This POM class encapsulates all interactions with the Login Report module.
 ...
 * LoginReport
 * 
 * Provides page object methods for Login Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new LoginReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class LoginReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Login Report';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/30821f51-598a-4f48-911e-e624bb39a377');
  }
