/**
 * IbanRegistrationRequests Page Object Model
 * 
 * Module: IBAN Registration Requests
 * URL: https://staging.tahseel.gov.ae/ManagePortal/iban-registeration/iban-registeration-requests
 * 
 * This POM class encapsulates all interactions with the IBAN Registration Requests module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module IbanRegistrationRequests
 */
...
/**
 * IbanRegistrationRequests
 * 
 * Provides page object methods for IBAN Registration Requests module.
 * 
 * Usage:
 * ```typescript
 * const page = new IbanRegistrationRequests(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class IbanRegistrationRequests extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'IBAN Registration Requests';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/iban-registeration/iban-registeration-requests';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/iban-registeration/iban-registeration-requests');
  }
