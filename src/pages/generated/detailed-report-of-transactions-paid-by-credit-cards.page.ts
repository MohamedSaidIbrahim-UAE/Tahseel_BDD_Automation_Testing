/**
 * DetailedReportOfTransactionsPaidByCreditCards Page Object Model
 * 
 * Module: Detailed Report of Transactions paid by Credit cards
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/617246e8-0006-4efb-b48e-c5fcb25fb18b
 * 
 * This POM class encapsulates all interactions with the Detailed Report of Transactions paid by Credit cards module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DetailedReportOfTransactionsPaidByCreditCards
 */
...
/**
 * DetailedReportOfTransactionsPaidByCreditCards
 * 
 * Provides page object methods for Detailed Report of Transactions paid by Credit cards module.
 * 
 * Usage:
 * ```typescript
 * const page = new DetailedReportOfTransactionsPaidByCreditCards(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DetailedReportOfTransactionsPaidByCreditCards extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Detailed Report of Transactions paid by Credit cards';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/617246e8-0006-4efb-b48e-c5fcb25fb18b';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/617246e8-0006-4efb-b48e-c5fcb25fb18b');
  }
