/**
 * SharedRevenuesBetweenTheDirectorateOfTownPlanningAndSurveyAndSharjahMunicipality Page Object Model
 * 
 * Module: Shared revenues between the Directorate Of Town Planning and Survey and Sharjah Municipality
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/d021f360-e2d9-4863-9ff3-bc231af2ecb7
 * 
 * This POM class encapsulates all interactions with the Shared revenues between the Directorate Of Town Planning and Survey and Sharjah Municipality module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SharedRevenuesBetweenTheDirectorateOfTownPlanningAndSurveyAndSharjahMunicipality
 */
...
/**
 * SharedRevenuesBetweenTheDirectorateOfTownPlanningAndSurveyAndSharjahMunicipality
 * 
 * Provides page object methods for Shared revenues between the Directorate Of Town Planning and Survey and Sharjah Municipality module.
 * 
 * Usage:
 * ```typescript
 * const page = new SharedRevenuesBetweenTheDirectorateOfTownPlanningAndSurveyAndSharjahMunicipality(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SharedRevenuesBetweenTheDirectorateOfTownPlanningAndSurveyAndSharjahMunicipality extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Shared revenues between the Directorate Of Town Planning and Survey and Sharjah Municipality';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/d021f360-e2d9-4863-9ff3-bc231af2ecb7');
  }
