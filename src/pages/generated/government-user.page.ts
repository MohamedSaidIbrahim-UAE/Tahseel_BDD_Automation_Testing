/**
 * GovernmentUser Page Object Model
 * 
 * Module: Government User
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/gov-users
 * 
 * This POM class encapsulates all interactions with the Government User module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module GovernmentUser
 */
 ...
 * GovernmentUser
 * 
 * Provides page object methods for Government User module.
 * 
 * Usage:
 * ```typescript
 * const page = new GovernmentUser(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class GovernmentUser extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Government User';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/gov-users';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/gov-users');
  }
