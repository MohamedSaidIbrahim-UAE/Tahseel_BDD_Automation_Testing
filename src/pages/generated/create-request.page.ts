/**
 * CreateRequest Page Object Model
 * 
 * Module: Create Request
 * URL: https://staging.tahseel.gov.ae/ManagePortal/transaction-payment-request/add
 * 
 * This POM class encapsulates all interactions with the Create Request module.
 ...
 * CreateRequest
 * 
 * Provides page object methods for Create Request module.
 * 
 * Usage:
 * ```typescript
 * const page = new CreateRequest(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class CreateRequest extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Create Request';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/transaction-payment-request/add';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/transaction-payment-request/add');
  }
