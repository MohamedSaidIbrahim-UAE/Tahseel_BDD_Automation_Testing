/**
 * AggregatedFeesReportTahseelCards Page Object Model
 * 
 * Module: Aggregated fees Report Tahseel Cards
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/886c659e-30eb-4956-b4d6-f1771a79a780
 * 
 * This POM class encapsulates all interactions with the Aggregated fees Report Tahseel Cards module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module AggregatedFeesReportTahseelCards
 */
 ...
 * 
 * Provides page object methods for Aggregated fees Report Tahseel Cards module.
 * 
 * Usage:
 * ```typescript
 * const page = new AggregatedFeesReportTahseelCards(playwrightPage);
...
export class AggregatedFeesReportTahseelCards extends BasePage {
   ...
   */
  readonly moduleName = 'Aggregated fees Report Tahseel Cards';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/886c659e-30eb-4956-b4d6-f1771a79a780';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/886c659e-30eb-4956-b4d6-f1771a79a780');
  }
