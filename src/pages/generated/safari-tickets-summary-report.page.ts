/**
 * SafariTicketsSummaryReport Page Object Model
 * 
 * Module: Safari Tickets Summary Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/109117db-66c8-4383-b572-7f2814c49ef7
 * 
 * This POM class encapsulates all interactions with the Safari Tickets Summary Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SafariTicketsSummaryReport
 */
...
/**
 * SafariTicketsSummaryReport
 * 
 * Provides page object methods for Safari Tickets Summary Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new SafariTicketsSummaryReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SafariTicketsSummaryReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Safari Tickets Summary Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/109117db-66c8-4383-b572-7f2814c49ef7';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/109117db-66c8-4383-b572-7f2814c49ef7');
  }
