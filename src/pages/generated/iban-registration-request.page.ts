/**
 * IbanRegistrationRequest Page Object Model
 * 
 * Module: IBAN Registration Request
 * URL: https://staging.tahseel.gov.ae/ManagePortal/iban-registeration/request-register-iban-details
 * 
 * This POM class encapsulates all interactions with the IBAN Registration Request module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module IbanRegistrationRequest
 */
...
/**
 * IbanRegistrationRequest
 * 
 * Provides page object methods for IBAN Registration Request module.
 * 
 * Usage:
 * ```typescript
 * const page = new IbanRegistrationRequest(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class IbanRegistrationRequest extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'IBAN Registration Request';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/iban-registeration/request-register-iban-details');
  }
