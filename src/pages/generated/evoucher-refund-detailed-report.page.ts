/**
 * EvoucherRefundDetailedReport Page Object Model
 * 
 * Module: Evoucher Refund Detailed Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/9ff647c1-daf1-4374-a898-3a77a4a3f158
 * 
 * This POM class encapsulates all interactions with the Evoucher Refund Detailed Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module EvoucherRefundDetailedReport
 */
...
/**
 * EvoucherRefundDetailedReport
 * 
 * Provides page object methods for Evoucher Refund Detailed Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new EvoucherRefundDetailedReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class EvoucherRefundDetailedReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Evoucher Refund Detailed Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/9ff647c1-daf1-4374-a898-3a77a4a3f158';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/9ff647c1-daf1-4374-a898-3a77a4a3f158');
  }
