/**
 * CompanyUser Page Object Model
 * 
 * Module: Company User
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/company-users
 * 
 * This POM class encapsulates all interactions with the Company User module.
 ...
 * CompanyUser
 * 
 * Provides page object methods for Company User module.
 * 
 * Usage:
 * ```typescript
 * const page = new CompanyUser(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class CompanyUser extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Company User';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/company-users';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/company-users');
  }
