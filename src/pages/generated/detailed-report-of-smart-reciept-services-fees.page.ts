/**
 * DetailedReportOfSmartRecieptServicesFees Page Object Model
 * 
 * Module: Detailed Report of Smart Reciept Services Fees
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/8fe08b0a-51d6-4c15-8467-8f334372b504
 * 
 * This POM class encapsulates all interactions with the Detailed Report of Smart Reciept Services Fees module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DetailedReportOfSmartRecieptServicesFees
 */
...
/**
 * DetailedReportOfSmartRecieptServicesFees
 * 
 * Provides page object methods for Detailed Report of Smart Reciept Services Fees module.
 * 
 * Usage:
 * ```typescript
 * const page = new DetailedReportOfSmartRecieptServicesFees(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DetailedReportOfSmartRecieptServicesFees extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Detailed Report of Smart Reciept Services Fees';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/8fe08b0a-51d6-4c15-8467-8f334372b504');
  }
