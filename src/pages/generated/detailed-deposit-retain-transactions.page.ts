/**
 * DetailedDepositRetainTransactions Page Object Model
 * 
 * Module: Detailed Deposit Retain Transactions
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/305938b7-8812-4dc5-8671-617f741c213c
 * 
 * This POM class encapsulates all interactions with the Detailed Deposit Retain Transactions module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DetailedDepositRetainTransactions
 */
...
/**
 * DetailedDepositRetainTransactions
 * 
 * Provides page object methods for Detailed Deposit Retain Transactions module.
 * 
 * Usage:
 * ```typescript
 * const page = new DetailedDepositRetainTransactions(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DetailedDepositRetainTransactions extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Detailed Deposit Retain Transactions';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/305938b7-8812-4dc5-8671-617f741c213c';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/305938b7-8812-4dc5-8671-617f741c213c');
  }
