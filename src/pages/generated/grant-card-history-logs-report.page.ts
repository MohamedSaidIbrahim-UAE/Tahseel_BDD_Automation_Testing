/**
 * GrantCardHistoryLogsReport Page Object Model
 * 
 * Module: Grant Card History Logs Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/1fd4b6c2-6ea3-4223-be7b-a6f4700e3c70
 * 
 * This POM class encapsulates all interactions with the Grant Card History Logs Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module GrantCardHistoryLogsReport
 */
...
/**
 * GrantCardHistoryLogsReport
 * 
 * Provides page object methods for Grant Card History Logs Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new GrantCardHistoryLogsReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class GrantCardHistoryLogsReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Grant Card History Logs Report';
  ...
  readonly selectors: Record<string, string> = {
    ...
    workflow_statusField: '[aria-label="Workflow Status"], label:has-text("Workflow Status") ~ input',
    publishing_houseField: '[aria-label="Publishing House"], label:has-text("Publishing House") ~ input',
    sheet_numberField: '[aria-label="Sheet Number"], label:has-text("Sheet Number") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/1fd4b6c2-6ea3-4223-be7b-a6f4700e3c70');
  }
