/**
 * MoneyLoaderGroups Page Object Model
 * 
 * Module: Money Loader Groups
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/money-loader-groups
 * 
 * This POM class encapsulates all interactions with the Money Loader Groups module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module MoneyLoaderGroups
 */
 ...
 * MoneyLoaderGroups
 * 
 * Provides page object methods for Money Loader Groups module.
 * 
 * Usage:
 * ```typescript
 * const page = new MoneyLoaderGroups(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class MoneyLoaderGroups extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Money Loader Groups';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/money-loader-groups';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/money-loader-groups');
  }
