/**
 * TahseelAccountLoadDetailsReport Page Object Model
 * 
 * Module: Tahseel Account Load Details Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/86723e25-d979-4224-8acc-68e9b90a683d
 * 
 * This POM class encapsulates all interactions with the Tahseel Account Load Details Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TahseelAccountLoadDetailsReport
 */
...
/**
 * TahseelAccountLoadDetailsReport
 * 
 * Provides page object methods for Tahseel Account Load Details Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new TahseelAccountLoadDetailsReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TahseelAccountLoadDetailsReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Tahseel Account Load Details Report';
  ...
  readonly selectors: Record<string, string> = {
    ...
    topup_transaction_typeField: '[aria-label="Top-up transaction type"], label:has-text("Top-up transaction type") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/86723e25-d979-4224-8acc-68e9b90a683d');
  }
