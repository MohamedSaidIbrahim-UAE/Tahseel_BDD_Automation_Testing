/**
 * Cheques Page Object Model
 * 
 * Module: Cheques
 * URL: https://staging.tahseel.gov.ae/ManagePortal/cheques/cheques
 * 
 * This POM class encapsulates all interactions with the Cheques module.
 ...
 * Cheques
 * 
 * Provides page object methods for Cheques module.
 * 
 * Usage:
 * ```typescript
 * const page = new Cheques(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class Cheques extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Cheques';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/cheques/cheques';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/cheques/cheques');
  }
