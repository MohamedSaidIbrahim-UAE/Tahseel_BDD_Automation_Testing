/**
 * TahseelAccounts Page Object Model
 * 
 * Module: Tahseel Accounts
 * URL: https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/7
 * 
 * This POM class encapsulates all interactions with the Tahseel Accounts module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TahseelAccounts
 */
 ...
 * TahseelAccounts
 * 
 * Provides page object methods for Tahseel Accounts module.
 * 
 * Usage:
 * ```typescript
 * const page = new TahseelAccounts(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TahseelAccounts extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Tahseel Accounts';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/7';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/7');
  }
