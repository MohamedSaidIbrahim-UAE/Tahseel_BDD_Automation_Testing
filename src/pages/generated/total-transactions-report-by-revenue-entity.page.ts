/**
 * TotalTransactionsReportByRevenueEntity Page Object Model
 * 
 * Module: Total Transactions report by revenue entity
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/350c32b5-7703-4a0c-b2ac-eda28a7011b5
 * 
 * This POM class encapsulates all interactions with the Total Transactions report by revenue entity module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TotalTransactionsReportByRevenueEntity
 */
...
/**
 * TotalTransactionsReportByRevenueEntity
 * 
 * Provides page object methods for Total Transactions report by revenue entity module.
 * 
 * Usage:
 * ```typescript
 * const page = new TotalTransactionsReportByRevenueEntity(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TotalTransactionsReportByRevenueEntity extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Total Transactions report by revenue entity';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/350c32b5-7703-4a0c-b2ac-eda28a7011b5';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/350c32b5-7703-4a0c-b2ac-eda28a7011b5');
  }
