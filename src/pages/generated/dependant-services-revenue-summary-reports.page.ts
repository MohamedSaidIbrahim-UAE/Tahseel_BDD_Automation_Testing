/**
 * DependantServicesRevenueSummaryReports Page Object Model
 * 
 * Module: Dependant services revenue summary reports
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/b541adc6-ef50-4019-aac2-32e748add600
 * 
 * This POM class encapsulates all interactions with the Dependant services revenue summary reports module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DependantServicesRevenueSummaryReports
 */
...
/**
 * DependantServicesRevenueSummaryReports
 * 
 * Provides page object methods for Dependant services revenue summary reports module.
 * 
 * Usage:
 * ```typescript
 * const page = new DependantServicesRevenueSummaryReports(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DependantServicesRevenueSummaryReports extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Dependant services revenue summary reports';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/b541adc6-ef50-4019-aac2-32e748add600';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/b541adc6-ef50-4019-aac2-32e748add600');
  }
