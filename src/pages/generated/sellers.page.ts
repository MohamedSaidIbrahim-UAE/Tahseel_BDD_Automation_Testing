/**
 * Sellers Page Object Model
 * 
 * Module: Sellers
 * URL: https://staging.tahseel.gov.ae/ManagePortal/sellers/seller
 * 
 * This POM class encapsulates all interactions with the Sellers module.
 ...
 * Sellers
 * 
 * Provides page object methods for Sellers module.
 * 
 * Usage:
 * ```typescript
 * const page = new Sellers(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class Sellers extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Sellers';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/sellers/seller';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/sellers/seller');
  }
