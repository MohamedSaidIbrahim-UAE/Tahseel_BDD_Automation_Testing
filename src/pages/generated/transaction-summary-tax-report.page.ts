/**
 * TransactionSummaryTaxReport Page Object Model
 * 
 * Module: Transaction Summary Tax Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/366f4450-11cf-4b44-a5b2-66c472dbe3c1
 * 
 * This POM class encapsulates all interactions with the Transaction Summary Tax Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TransactionSummaryTaxReport
 */
...
/**
 * TransactionSummaryTaxReport
 * 
 * Provides page object methods for Transaction Summary Tax Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new TransactionSummaryTaxReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TransactionSummaryTaxReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Transaction Summary Tax Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/366f4450-11cf-4b44-a5b2-66c472dbe3c1';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/366f4450-11cf-4b44-a5b2-66c472dbe3c1');
  }
