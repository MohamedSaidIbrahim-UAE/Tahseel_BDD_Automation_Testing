/**
 * FeeFreeTransactions Page Object Model
 * 
 * Module: Fee-free transactions
 * URL: https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/3
 * 
 * This POM class encapsulates all interactions with the Fee-free transactions module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module FeeFreeTransactions
 */
 ...
 * FeeFreeTransactions
 * 
 * Provides page object methods for Fee-free transactions module.
 * 
 * Usage:
 * ```typescript
 * const page = new FeeFreeTransactions(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class FeeFreeTransactions extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Fee-free transactions';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/3';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/3');
  }
