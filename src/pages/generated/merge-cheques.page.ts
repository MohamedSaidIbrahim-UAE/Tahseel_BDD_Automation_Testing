/**
 * MergeCheques Page Object Model
 * 
 * Module: Merge Cheques
 * URL: https://staging.tahseel.gov.ae/ManagePortal/cheques/merge
 * 
 * This POM class encapsulates all interactions with the Merge Cheques module.
 ...
 * MergeCheques
 * 
 * Provides page object methods for Merge Cheques module.
 * 
 * Usage:
 * ```typescript
 * const page = new MergeCheques(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class MergeCheques extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Merge Cheques';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/cheques/merge';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/cheques/merge');
  }
