/**
 * IbanRegistrationPendingRequests Page Object Model
 * 
 * Module: IBAN Registration Pending Requests
 * URL: https://staging.tahseel.gov.ae/ManagePortal/iban-registeration/iban-registeration-pending-requests
 * 
 * This POM class encapsulates all interactions with the IBAN Registration Pending Requests module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module IbanRegistrationPendingRequests
 */
...
/**
 * IbanRegistrationPendingRequests
 * 
 * Provides page object methods for IBAN Registration Pending Requests module.
 * 
 * Usage:
 * ```typescript
 * const page = new IbanRegistrationPendingRequests(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class IbanRegistrationPendingRequests extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'IBAN Registration Pending Requests';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/iban-registeration/iban-registeration-pending-requests';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/iban-registeration/iban-registeration-pending-requests');
  }
