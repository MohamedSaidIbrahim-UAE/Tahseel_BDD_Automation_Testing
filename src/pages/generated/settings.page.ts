 ...
 * 
 * Module: Settings
 * URL: https://staging.tahseel.gov.ae/ManagePortal/feature
 * 
 * This POM class encapsulates all interactions with the Settings module.
 ...
 * Settings
 * 
 * Provides page object methods for Settings module.
 * 
 * Usage:
 * ```typescript
 * const page = new Settings(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class Settings extends BaseListPage {
  /**
   ...
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/feature';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/feature');
  }
