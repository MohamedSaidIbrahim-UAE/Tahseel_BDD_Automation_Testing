/**
 * ChequePaymentDetailsReport Page Object Model
 * 
 * Module: Cheque Payment Details Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/976a3d52-eb5d-4d49-8742-886f35c086f2
 * 
 * This POM class encapsulates all interactions with the Cheque Payment Details Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module ChequePaymentDetailsReport
 */
...
/**
 * ChequePaymentDetailsReport
 * 
 * Provides page object methods for Cheque Payment Details Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new ChequePaymentDetailsReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class ChequePaymentDetailsReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Cheque Payment Details Report';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/976a3d52-eb5d-4d49-8742-886f35c086f2');
  }
