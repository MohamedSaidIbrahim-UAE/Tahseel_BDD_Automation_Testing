/**
 * DetailedTahseelCardReport Page Object Model
 * 
 * Module: Detailed Tahseel Card Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/adf3c414-e56d-4e98-82e7-790dcac7a570
 * 
 * This POM class encapsulates all interactions with the Detailed Tahseel Card Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DetailedTahseelCardReport
 */
...
/**
 * DetailedTahseelCardReport
 * 
 * Provides page object methods for Detailed Tahseel Card Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new DetailedTahseelCardReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DetailedTahseelCardReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Detailed Tahseel Card Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/adf3c414-e56d-4e98-82e7-790dcac7a570';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/adf3c414-e56d-4e98-82e7-790dcac7a570');
  }
