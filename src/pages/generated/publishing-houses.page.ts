/**
 * PublishingHouses Page Object Model
 * 
 * Module: Publishing Houses
 * URL: https://staging.tahseel.gov.ae/ManagePortal/exhibition/publishing-house
 * 
 * This POM class encapsulates all interactions with the Publishing Houses module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module PublishingHouses
 */
 ...
 * PublishingHouses
 * 
 * Provides page object methods for Publishing Houses module.
 * 
 * Usage:
 * ```typescript
 * const page = new PublishingHouses(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class PublishingHouses extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Publishing Houses';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/exhibition/publishing-house';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/exhibition/publishing-house');
  }
