/**
 * TransactionFeesForAllPaymentMethods Page Object Model
 * 
 * Module: Transaction Fees For All Payment Methods
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/97353334-399a-4613-9097-9cf5dc95c690
 * 
 * This POM class encapsulates all interactions with the Transaction Fees For All Payment Methods module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TransactionFeesForAllPaymentMethods
 */
 ...
 * 
 * Provides page object methods for Transaction Fees For All Payment Methods module.
 * 
 * Usage:
 * ```typescript
 * const page = new TransactionFeesForAllPaymentMethods(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TransactionFeesForAllPaymentMethods extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Transaction Fees For All Payment Methods';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/97353334-399a-4613-9097-9cf5dc95c690';
  ...
  readonly selectors: Record<string, string> = {
    ...
    typeField: '[aria-label="Type"], label:has-text("Type") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/97353334-399a-4613-9097-9cf5dc95c690');
  }
