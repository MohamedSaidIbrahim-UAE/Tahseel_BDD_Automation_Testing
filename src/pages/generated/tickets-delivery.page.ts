/**
 * TicketsDelivery Page Object Model
 * 
 * Module: Tickets Delivery
 * URL: https://staging.tahseel.gov.ae/ManagePortal/tickets/tickets-delivery
 * 
 * This POM class encapsulates all interactions with the Tickets Delivery module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TicketsDelivery
 */
 ...
 * TicketsDelivery
 * 
 * Provides page object methods for Tickets Delivery module.
 * 
 * Usage:
 * ```typescript
 * const page = new TicketsDelivery(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TicketsDelivery extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Tickets Delivery';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/tickets/tickets-delivery');
  }
