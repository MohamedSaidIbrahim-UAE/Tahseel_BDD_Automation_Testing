/**
 * MoneyLoaderUser Page Object Model
 * 
 * Module: Money Loader User
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/money-loader-users
 * 
 * This POM class encapsulates all interactions with the Money Loader User module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module MoneyLoaderUser
 */
 ...
 * MoneyLoaderUser
 * 
 * Provides page object methods for Money Loader User module.
 * 
 * Usage:
 * ```typescript
 * const page = new MoneyLoaderUser(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class MoneyLoaderUser extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Money Loader User';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/money-loader-users';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/money-loader-users');
  }
