/**
 * ADetailedReportForLoadingUsingAlThiqaClubEmployeeCard Page Object Model
 * 
 * Module: A detailed report for Loading using Al Thiqa Club employee card
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/80cacf55-4ccc-478a-bcd1-194e17c4e28c
 * 
 * This POM class encapsulates all interactions with the A detailed report for Loading using Al Thiqa Club employee card module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module ADetailedReportForLoadingUsingAlThiqaClubEmployeeCard
 */
...
/**
 * ADetailedReportForLoadingUsingAlThiqaClubEmployeeCard
 * 
 * Provides page object methods for A detailed report for Loading using Al Thiqa Club employee card module.
 * 
 * Usage:
 * ```typescript
 * const page = new ADetailedReportForLoadingUsingAlThiqaClubEmployeeCard(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class ADetailedReportForLoadingUsingAlThiqaClubEmployeeCard extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'A detailed report for Loading using Al Thiqa Club employee card';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/80cacf55-4ccc-478a-bcd1-194e17c4e28c');
  }
