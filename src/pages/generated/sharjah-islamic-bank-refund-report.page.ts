/**
 * SharjahIslamicBankRefundReport Page Object Model
 * 
 * Module: Sharjah islamic bank refund report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/f19d354b-130e-472c-bb69-5fe8d718276f
 * 
 * This POM class encapsulates all interactions with the Sharjah islamic bank refund report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SharjahIslamicBankRefundReport
 */
...
/**
 * SharjahIslamicBankRefundReport
 * 
 * Provides page object methods for Sharjah islamic bank refund report module.
 * 
 * Usage:
 * ```typescript
 * const page = new SharjahIslamicBankRefundReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SharjahIslamicBankRefundReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Sharjah islamic bank refund report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/f19d354b-130e-472c-bb69-5fe8d718276f';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/f19d354b-130e-472c-bb69-5fe8d718276f');
  }
