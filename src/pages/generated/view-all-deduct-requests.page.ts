/**
 * ViewAllDeductRequests Page Object Model
 * 
 * Module: View All Deduct Requests
 * URL: https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/all-deduct-requests-list
 * 
 * This POM class encapsulates all interactions with the View All Deduct Requests module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module ViewAllDeductRequests
 */
...
/**
 * ViewAllDeductRequests
 * 
 * Provides page object methods for View All Deduct Requests module.
 * 
 * Usage:
 * ```typescript
 * const page = new ViewAllDeductRequests(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class ViewAllDeductRequests extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'View All Deduct Requests';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/all-deduct-requests-list';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/all-deduct-requests-list');
  }
