/**
 * AReportOnJointRevenuesBetweenThePreventionAndSafetyAuthorityAndSand Page Object Model
 * 
 * Module: A report on joint revenues between the Prevention and Safety Authority and SAND
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/2922f019-ada2-4466-b230-2d9f0eea6ac7
 * 
 * This POM class encapsulates all interactions with the A report on joint revenues between the Prevention and Safety Authority and SAND module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module AReportOnJointRevenuesBetweenThePreventionAndSafetyAuthorityAndSand
 */
...
/**
 * AReportOnJointRevenuesBetweenThePreventionAndSafetyAuthorityAndSand
 * 
 * Provides page object methods for A report on joint revenues between the Prevention and Safety Authority and SAND module.
 * 
 * Usage:
 * ```typescript
 * const page = new AReportOnJointRevenuesBetweenThePreventionAndSafetyAuthorityAndSand(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class AReportOnJointRevenuesBetweenThePreventionAndSafetyAuthorityAndSand extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'A report on joint revenues between the Prevention and Safety Authority and SAND';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/2922f019-ada2-4466-b230-2d9f0eea6ac7');
  }
