/**
 * TransactionsAnalysis Page Object Model
 * 
 * Module: Transactions Analysis
 * URL: https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/1
 * 
 * This POM class encapsulates all interactions with the Transactions Analysis module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TransactionsAnalysis
 */
 ...
 * 
 * Provides page object methods for Transactions Analysis module.
 * 
 * Usage:
 * ```typescript
 * const page = new TransactionsAnalysis(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TransactionsAnalysis extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Transactions Analysis';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/1';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/1');
  }
