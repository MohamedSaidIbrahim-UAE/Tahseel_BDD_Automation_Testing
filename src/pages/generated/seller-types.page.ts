/**
 * SellerTypes Page Object Model
 * 
 * Module: Seller Types
 * URL: https://staging.tahseel.gov.ae/ManagePortal/sellers/types
 * 
 * This POM class encapsulates all interactions with the Seller Types module.
 ...
 * SellerTypes
 * 
 * Provides page object methods for Seller Types module.
 * 
 * Usage:
 * ```typescript
 * const page = new SellerTypes(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SellerTypes extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Seller Types';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/sellers/types';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/sellers/types');
  }
