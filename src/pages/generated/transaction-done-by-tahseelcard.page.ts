/**
 * TransactionDoneByTahseelcard Page Object Model
 * 
 * Module: Transaction Done by TahseelCard
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/ae276954-24ac-4a88-a3ca-9b00897840a4
 * 
 * This POM class encapsulates all interactions with the Transaction Done by TahseelCard module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TransactionDoneByTahseelcard
 */
...
/**
 * TransactionDoneByTahseelcard
 * 
 * Provides page object methods for Transaction Done by TahseelCard module.
 * 
 * Usage:
 * ```typescript
 * const page = new TransactionDoneByTahseelcard(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TransactionDoneByTahseelcard extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Transaction Done by TahseelCard';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/ae276954-24ac-4a88-a3ca-9b00897840a4';
  ...
  readonly selectors: Record<string, string> = {
    ...
    account_noField: '[aria-label="Account No"], label:has-text("Account No") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/ae276954-24ac-4a88-a3ca-9b00897840a4');
  }
