/**
 * OperatorUser Page Object Model
 * 
 * Module: Operator User
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/operator-users
 * 
 * This POM class encapsulates all interactions with the Operator User module.
 ...
 * OperatorUser
 * 
 * Provides page object methods for Operator User module.
 * 
 * Usage:
 * ```typescript
 * const page = new OperatorUser(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class OperatorUser extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Operator User';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/operator-users';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/operator-users');
  }
