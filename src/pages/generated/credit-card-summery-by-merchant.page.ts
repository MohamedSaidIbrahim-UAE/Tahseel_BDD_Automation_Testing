/**
 * CreditCardSummeryByMerchant Page Object Model
 * 
 * Module: Credit Card Summery By Merchant
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/008d2c86-ddcd-40c2-8e54-1036cc94c066
 * 
 * This POM class encapsulates all interactions with the Credit Card Summery By Merchant module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module CreditCardSummeryByMerchant
 */
...
/**
 * CreditCardSummeryByMerchant
 * 
 * Provides page object methods for Credit Card Summery By Merchant module.
 * 
 * Usage:
 * ```typescript
 * const page = new CreditCardSummeryByMerchant(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class CreditCardSummeryByMerchant extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Credit Card Summery By Merchant';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/008d2c86-ddcd-40c2-8e54-1036cc94c066';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/008d2c86-ddcd-40c2-8e54-1036cc94c066');
  }
