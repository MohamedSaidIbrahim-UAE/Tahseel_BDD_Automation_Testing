/**
 * SfdTahseelCardDetailReport Page Object Model
 * 
 * Module: SFD Tahseel Card Detail Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/a0477266-26c2-498c-b4e1-d66d30256992
 * 
 * This POM class encapsulates all interactions with the SFD Tahseel Card Detail Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SfdTahseelCardDetailReport
 */
...
/**
 * SfdTahseelCardDetailReport
 * 
 * Provides page object methods for SFD Tahseel Card Detail Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new SfdTahseelCardDetailReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SfdTahseelCardDetailReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'SFD Tahseel Card Detail Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/a0477266-26c2-498c-b4e1-d66d30256992';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/a0477266-26c2-498c-b4e1-d66d30256992');
  }
