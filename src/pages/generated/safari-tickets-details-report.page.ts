/**
 * SafariTicketsDetailsReport Page Object Model
 * 
 * Module: Safari Tickets Details Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/98397c90-14e2-46dc-9137-e047deac7d15
 * 
 * This POM class encapsulates all interactions with the Safari Tickets Details Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SafariTicketsDetailsReport
 */
...
/**
 * SafariTicketsDetailsReport
 * 
 * Provides page object methods for Safari Tickets Details Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new SafariTicketsDetailsReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SafariTicketsDetailsReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Safari Tickets Details Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/98397c90-14e2-46dc-9137-e047deac7d15';
  ...
  readonly selectors: Record<string, string> = {
    ...
    date_typeField: '[aria-label="Date Type"], label:has-text("Date Type") ~ input',
    ...
    application_numberField: '[aria-label="Application Number"], label:has-text("Application Number") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/98397c90-14e2-46dc-9137-e047deac7d15');
  }
