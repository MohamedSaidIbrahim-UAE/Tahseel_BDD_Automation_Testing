/**
 * PermanentPermissionLogReport Page Object Model
 * 
 * Module: Permanent permission Log report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/1d3b9315-5f9b-4950-bcb2-d1fce68ed561
 * 
 * This POM class encapsulates all interactions with the Permanent permission Log report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module PermanentPermissionLogReport
 */
...
/**
 * PermanentPermissionLogReport
 * 
 * Provides page object methods for Permanent permission Log report module.
 * 
 * Usage:
 * ```typescript
 * const page = new PermanentPermissionLogReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class PermanentPermissionLogReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Permanent permission Log report';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/1d3b9315-5f9b-4950-bcb2-d1fce68ed561');
  }
