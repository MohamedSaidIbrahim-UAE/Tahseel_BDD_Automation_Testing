/**
 * InquireIssue Page Object Model
 * 
 * Module: Inquire Issue
 * URL: https://staging.tahseel.gov.ae/ManagePortal/Communications/inquire-issues
 * 
 * This POM class encapsulates all interactions with the Inquire Issue module.
 ...
 * InquireIssue
 * 
 * Provides page object methods for Inquire Issue module.
 * 
 * Usage:
 * ```typescript
 * const page = new InquireIssue(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class InquireIssue extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Inquire Issue';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/Communications/inquire-issues';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/Communications/inquire-issues');
  }
