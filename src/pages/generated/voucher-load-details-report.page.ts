/**
 * VoucherLoadDetailsReport Page Object Model
 * 
 * Module: Voucher Load Details Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/130dfd7c-fe06-425f-8152-1da0e4d6225d
 * 
 * This POM class encapsulates all interactions with the Voucher Load Details Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module VoucherLoadDetailsReport
 */
...
/**
 * VoucherLoadDetailsReport
 * 
 * Provides page object methods for Voucher Load Details Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new VoucherLoadDetailsReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class VoucherLoadDetailsReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Voucher Load Details Report';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/130dfd7c-fe06-425f-8152-1da0e4d6225d');
  }
