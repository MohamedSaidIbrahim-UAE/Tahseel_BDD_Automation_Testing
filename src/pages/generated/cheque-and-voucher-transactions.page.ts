/**
 * ChequeAndVoucherTransactions Page Object Model
 * 
 * Module: Cheque and Voucher Transactions
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/46cc8ae5-b364-4b0d-826f-646dc8278110
 * 
 * This POM class encapsulates all interactions with the Cheque and Voucher Transactions module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module ChequeAndVoucherTransactions
 */
...
/**
 * ChequeAndVoucherTransactions
 * 
 * Provides page object methods for Cheque and Voucher Transactions module.
 * 
 * Usage:
 * ```typescript
 * const page = new ChequeAndVoucherTransactions(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class ChequeAndVoucherTransactions extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Cheque and Voucher Transactions';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/46cc8ae5-b364-4b0d-826f-646dc8278110';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/46cc8ae5-b364-4b0d-826f-646dc8278110');
  }
