/**
 * TransactionDetailsTaxReport Page Object Model
 * 
 * Module: Transaction Details Tax Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/ebf56e0d-5648-4cd2-8ed3-f16b8c58d0a8
 * 
 * This POM class encapsulates all interactions with the Transaction Details Tax Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TransactionDetailsTaxReport
 */
...
/**
 * TransactionDetailsTaxReport
 * 
 * Provides page object methods for Transaction Details Tax Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new TransactionDetailsTaxReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TransactionDetailsTaxReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Transaction Details Tax Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/ebf56e0d-5648-4cd2-8ed3-f16b8c58d0a8';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/ebf56e0d-5648-4cd2-8ed3-f16b8c58d0a8');
  }
