/**
 * CreditCardTransactionsInquiry Page Object Model
 * 
 * Module: Credit Card Transactions Inquiry
 * URL: https://staging.tahseel.gov.ae/ManagePortal/help-desk/credit-card-inquiry
 * 
 * This POM class encapsulates all interactions with the Credit Card Transactions Inquiry module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module CreditCardTransactionsInquiry
 */
...
/**
 * CreditCardTransactionsInquiry
 * 
 * Provides page object methods for Credit Card Transactions Inquiry module.
 * 
 * Usage:
 * ```typescript
 * const page = new CreditCardTransactionsInquiry(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class CreditCardTransactionsInquiry extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Credit Card Transactions Inquiry';
  ...
  readonly selectors: Record<string, string> = {
    ...
    search_dateField: '[aria-label="Search Date"], label:has-text("Search Date") ~ input',
    application_numberField: '[aria-label="Application Number"], label:has-text("Application Number") ~ input',
    card_numberField: '[aria-label="Card Number"], label:has-text("Card Number") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/help-desk/credit-card-inquiry');
  }
