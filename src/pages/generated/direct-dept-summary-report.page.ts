/**
 * DirectDeptSummaryReport Page Object Model
 * 
 * Module: Direct Dept Summary Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/ed049e73-9ec3-4f7b-bd70-876c2e75e420
 * 
 * This POM class encapsulates all interactions with the Direct Dept Summary Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DirectDeptSummaryReport
 */
...
/**
 * DirectDeptSummaryReport
 * 
 * Provides page object methods for Direct Dept Summary Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new DirectDeptSummaryReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DirectDeptSummaryReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Direct Dept Summary Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/ed049e73-9ec3-4f7b-bd70-876c2e75e420';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/ed049e73-9ec3-4f7b-bd70-876c2e75e420');
  }
