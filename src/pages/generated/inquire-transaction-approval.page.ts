/**
 * InquireTransactionApproval Page Object Model
 * 
 * Module: Inquire Transaction Approval
 * URL: https://staging.tahseel.gov.ae/ManagePortal/transaction-payment-request/inquire
 * 
 * This POM class encapsulates all interactions with the Inquire Transaction Approval module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module InquireTransactionApproval
 */
...
/**
 * InquireTransactionApproval
 * 
 * Provides page object methods for Inquire Transaction Approval module.
 * 
 * Usage:
 * ```typescript
 * const page = new InquireTransactionApproval(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class InquireTransactionApproval extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Inquire Transaction Approval';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/transaction-payment-request/inquire';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/transaction-payment-request/inquire');
  }
