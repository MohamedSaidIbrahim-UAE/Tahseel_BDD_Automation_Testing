/**
 * DetailedChequesReport Page Object Model
 * 
 * Module: Detailed Cheques Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/1d09c6bb-d8e2-4f39-a1d2-2527fe554373
 * 
 * This POM class encapsulates all interactions with the Detailed Cheques Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DetailedChequesReport
 */
...
/**
 * DetailedChequesReport
 * 
 * Provides page object methods for Detailed Cheques Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new DetailedChequesReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DetailedChequesReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Detailed Cheques Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/1d09c6bb-d8e2-4f39-a1d2-2527fe554373';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/1d09c6bb-d8e2-4f39-a1d2-2527fe554373');
  }
