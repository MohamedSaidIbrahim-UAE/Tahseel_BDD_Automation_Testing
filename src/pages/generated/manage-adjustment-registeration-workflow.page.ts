/**
 * ManageAdjustmentRegisterationWorkflow Page Object Model
 * 
 * Module: Manage Adjustment Registeration Workflow
 * URL: https://staging.tahseel.gov.ae/ManagePortal/workflowManag/adjustment-registeration-workflow
 * 
 * This POM class encapsulates all interactions with the Manage Adjustment Registeration Workflow module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module ManageAdjustmentRegisterationWorkflow
 */
...
/**
 * ManageAdjustmentRegisterationWorkflow
 * 
 * Provides page object methods for Manage Adjustment Registeration Workflow module.
 * 
 * Usage:
 * ```typescript
 * const page = new ManageAdjustmentRegisterationWorkflow(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class ManageAdjustmentRegisterationWorkflow extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Manage Adjustment Registeration Workflow';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/workflowManag/adjustment-registeration-workflow';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/workflowManag/adjustment-registeration-workflow');
  }
