/**
 * TransactionDepositsDetailReportreceivable Page Object Model
 * 
 * Module: Transaction deposits detail Report (receivable)
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/962e3249-71d7-4dc9-973d-da2005ae7745
 * 
 * This POM class encapsulates all interactions with the Transaction deposits detail Report (receivable) module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TransactionDepositsDetailReportreceivable
 */
...
/**
 * TransactionDepositsDetailReportreceivable
 * 
 * Provides page object methods for Transaction deposits detail Report (receivable) module.
 * 
 * Usage:
 * ```typescript
 * const page = new TransactionDepositsDetailReportreceivable(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TransactionDepositsDetailReportreceivable extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Transaction deposits detail Report (receivable)';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/962e3249-71d7-4dc9-973d-da2005ae7745';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/962e3249-71d7-4dc9-973d-da2005ae7745');
  }
