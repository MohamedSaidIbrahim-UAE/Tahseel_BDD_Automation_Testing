/**
 * TransactionsMap Page Object Model
 * 
 * Module: Transactions Map
 * URL: https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/6
 * 
 * This POM class encapsulates all interactions with the Transactions Map module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TransactionsMap
 */
 ...
 * TransactionsMap
 * 
 * Provides page object methods for Transactions Map module.
 * 
 * Usage:
 * ```typescript
 * const page = new TransactionsMap(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TransactionsMap extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Transactions Map';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/6';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/6');
  }
