/**
 * DepositsDetailsReport Page Object Model
 * 
 * Module: Deposits Details Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/d2edb386-9416-4c19-a39c-451f5d6414b2
 * 
 * This POM class encapsulates all interactions with the Deposits Details Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DepositsDetailsReport
 */
...
/**
 * DepositsDetailsReport
 * 
 * Provides page object methods for Deposits Details Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new DepositsDetailsReport(playwrightPage);
...
export class DepositsDetailsReport extends BaseListPage {
   ...
   */
  readonly moduleName = 'Deposits Details Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/d2edb386-9416-4c19-a39c-451f5d6414b2';
  ...
  readonly selectors: Record<string, string> = {
    ...
    show_deposit_with_zero_valueField: '[aria-label="Show deposit with zero value"], label:has-text("Show deposit with zero value") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/d2edb386-9416-4c19-a39c-451f5d6414b2');
  }
