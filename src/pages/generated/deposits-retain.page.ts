/**
 * DepositsRetain Page Object Model
 * 
 * Module: Deposits Retain
 * URL: https://staging.tahseel.gov.ae/ManagePortal/deposits/depositRetain
 * 
 * This POM class encapsulates all interactions with the Deposits Retain module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DepositsRetain
 */
 ...
 * DepositsRetain
 * 
 * Provides page object methods for Deposits Retain module.
 * 
 * Usage:
 * ```typescript
 * const page = new DepositsRetain(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DepositsRetain extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Deposits Retain';
  ...
  readonly selectors: Record<string, string> = {
    ...
    available_amount0_aedField: '[aria-label="Available Amount0 AED"], label:has-text("Available Amount0 AED") ~ input',
    available_amountField: '[aria-label="Available Amount"], label:has-text("Available Amount") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/deposits/depositRetain');
  }
