/**
 * UaeCentralBankSettlementReportInPeriod Page Object Model
 * 
 * Module: UAE central bank settlement report in period
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/996869c3-66af-4ab1-a8dc-c12acb13aa71
 * 
 * This POM class encapsulates all interactions with the UAE central bank settlement report in period module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module UaeCentralBankSettlementReportInPeriod
 */
...
/**
 * UaeCentralBankSettlementReportInPeriod
 * 
 * Provides page object methods for UAE central bank settlement report in period module.
 * 
 * Usage:
 * ```typescript
 * const page = new UaeCentralBankSettlementReportInPeriod(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class UaeCentralBankSettlementReportInPeriod extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'UAE central bank settlement report in period';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/996869c3-66af-4ab1-a8dc-c12acb13aa71';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/996869c3-66af-4ab1-a8dc-c12acb13aa71');
  }
