/**
 * SummaryTransactionsReport Page Object Model
 * 
 * Module: Summary Transactions Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/132a8205-691c-4c1d-92f5-5c507020940e
 * 
 * This POM class encapsulates all interactions with the Summary Transactions Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SummaryTransactionsReport
 */
...
/**
 * SummaryTransactionsReport
 * 
 * Provides page object methods for Summary Transactions Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new SummaryTransactionsReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SummaryTransactionsReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Summary Transactions Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/132a8205-691c-4c1d-92f5-5c507020940e';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/132a8205-691c-4c1d-92f5-5c507020940e');
  }
