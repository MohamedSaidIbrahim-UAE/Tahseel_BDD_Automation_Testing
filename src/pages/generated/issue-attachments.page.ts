/**
 * IssueAttachments Page Object Model
 * 
 * Module: Issue Attachments
 * URL: https://staging.tahseel.gov.ae/ManagePortal/issue/issue-attachment-management
 * 
 * This POM class encapsulates all interactions with the Issue Attachments module.
 ...
 * IssueAttachments
 * 
 * Provides page object methods for Issue Attachments module.
 * 
 * Usage:
 * ```typescript
 * const page = new IssueAttachments(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class IssueAttachments extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Issue Attachments';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/issue/issue-attachment-management';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/issue/issue-attachment-management');
  }
