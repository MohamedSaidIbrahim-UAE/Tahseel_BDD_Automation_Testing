/**
 * Refunds Page Object Model
 * 
 * Module: Refunds
 * URL: https://staging.tahseel.gov.ae/ManagePortal/refund
 * 
 * This POM class encapsulates all interactions with the Refunds module.
 ...
 * Refunds
 * 
 * Provides page object methods for Refunds module.
 * 
 * Usage:
 * ```typescript
 * const page = new Refunds(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class Refunds extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Refunds';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/refund');
  }
