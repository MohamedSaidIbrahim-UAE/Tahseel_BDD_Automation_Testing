/**
 * ServiceRules Page Object Model
 * 
 * Module: Service Rules
 * URL: https://staging.tahseel.gov.ae/ManagePortal/hierarchy/service-rules
 * 
 * This POM class encapsulates all interactions with the Service Rules module.
 ...
 * ServiceRules
 * 
 * Provides page object methods for Service Rules module.
 * 
 * Usage:
 * ```typescript
 * const page = new ServiceRules(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class ServiceRules extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Service Rules';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/hierarchy/service-rules';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/hierarchy/service-rules');
  }
