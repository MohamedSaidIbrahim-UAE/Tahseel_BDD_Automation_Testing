/**
 * AutomaticTransactionRefundReport Page Object Model
 * 
 * Module: Automatic Transaction Refund Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/8ffdd544-e588-4ba0-9b21-174752d77f01
 * 
 * This POM class encapsulates all interactions with the Automatic Transaction Refund Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module AutomaticTransactionRefundReport
 */
...
/**
 * AutomaticTransactionRefundReport
 * 
 * Provides page object methods for Automatic Transaction Refund Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new AutomaticTransactionRefundReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class AutomaticTransactionRefundReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Automatic Transaction Refund Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/8ffdd544-e588-4ba0-9b21-174752d77f01';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/8ffdd544-e588-4ba0-9b21-174752d77f01');
  }
