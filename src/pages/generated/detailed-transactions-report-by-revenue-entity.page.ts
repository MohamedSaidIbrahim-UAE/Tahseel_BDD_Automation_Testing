/**
 * DetailedTransactionsReportByRevenueEntity Page Object Model
 * 
 * Module: Detailed Transactions report by revenue entity
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/6febbbae-d675-44e9-b5ca-418a09be5c72
 * 
 * This POM class encapsulates all interactions with the Detailed Transactions report by revenue entity module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DetailedTransactionsReportByRevenueEntity
 */
...
/**
 * DetailedTransactionsReportByRevenueEntity
 * 
 * Provides page object methods for Detailed Transactions report by revenue entity module.
 * 
 * Usage:
 * ```typescript
 * const page = new DetailedTransactionsReportByRevenueEntity(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DetailedTransactionsReportByRevenueEntity extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Detailed Transactions report by revenue entity';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/6febbbae-d675-44e9-b5ca-418a09be5c72';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/6febbbae-d675-44e9-b5ca-418a09be5c72');
  }
