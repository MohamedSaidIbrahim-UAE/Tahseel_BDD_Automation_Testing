/**
 * TopupClientsStations Page Object Model
 * 
 * Module: Topup Clients Stations
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/topup-clients-stations
 * 
 * This POM class encapsulates all interactions with the Topup Clients Stations module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TopupClientsStations
 */
...
/**
 * TopupClientsStations
 * 
 * Provides page object methods for Topup Clients Stations module.
 * 
 * Usage:
 * ```typescript
 * const page = new TopupClientsStations(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TopupClientsStations extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Topup Clients Stations';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/topup-clients-stations';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/topup-clients-stations');
  }
