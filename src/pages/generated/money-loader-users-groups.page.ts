/**
 * MoneyLoaderUsersGroups Page Object Model
 * 
 * Module: Money Loader Users Groups
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/money-loader-users-groups
 * 
 * This POM class encapsulates all interactions with the Money Loader Users Groups module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module MoneyLoaderUsersGroups
 */
...
/**
 * MoneyLoaderUsersGroups
 * 
 * Provides page object methods for Money Loader Users Groups module.
 * 
 * Usage:
 * ```typescript
 * const page = new MoneyLoaderUsersGroups(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class MoneyLoaderUsersGroups extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Money Loader Users Groups';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/money-loader-users-groups';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/money-loader-users-groups');
  }
