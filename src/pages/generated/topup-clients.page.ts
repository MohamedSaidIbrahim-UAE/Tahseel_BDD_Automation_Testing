/**
 * TopupClients Page Object Model
 * 
 * Module: Topup Clients
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/topup-clients
 * 
 * This POM class encapsulates all interactions with the Topup Clients module.
 ...
 * TopupClients
 * 
 * Provides page object methods for Topup Clients module.
 * 
 * Usage:
 * ```typescript
 * const page = new TopupClients(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TopupClients extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Topup Clients';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/topup-clients';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/topup-clients');
  }
