/**
 * TransactionAudit Page Object Model
 * 
 * Module: Transaction Audit
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/d2c0be57-c424-4984-9d3e-b748bc280c3d
 * 
 * This POM class encapsulates all interactions with the Transaction Audit module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TransactionAudit
 */
 ...
 * TransactionAudit
 * 
 * Provides page object methods for Transaction Audit module.
 * 
 * Usage:
 * ```typescript
 * const page = new TransactionAudit(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TransactionAudit extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Transaction Audit';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/d2c0be57-c424-4984-9d3e-b748bc280c3d';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/d2c0be57-c424-4984-9d3e-b748bc280c3d');
  }
