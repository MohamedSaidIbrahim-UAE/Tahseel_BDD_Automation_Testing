/**
 * ChequesTransactions Page Object Model
 * 
 * Module: Cheques Transactions
 * URL: https://staging.tahseel.gov.ae/ManagePortal/cheques/transactions
 * 
 * This POM class encapsulates all interactions with the Cheques Transactions module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module ChequesTransactions
 */
 ...
 * ChequesTransactions
 * 
 * Provides page object methods for Cheques Transactions module.
 * 
 * Usage:
 * ```typescript
 * const page = new ChequesTransactions(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class ChequesTransactions extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Cheques Transactions';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/cheques/transactions';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/cheques/transactions');
  }
