/**
 * PermanentPermissionReport Page Object Model
 * 
 * Module: Permanent permission report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/d2459787-dcc3-4b93-b909-cd59afefb457
 * 
 * This POM class encapsulates all interactions with the Permanent permission report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module PermanentPermissionReport
 */
...
/**
 * PermanentPermissionReport
 * 
 * Provides page object methods for Permanent permission report module.
 * 
 * Usage:
 * ```typescript
 * const page = new PermanentPermissionReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class PermanentPermissionReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Permanent permission report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/d2459787-dcc3-4b93-b909-cd59afefb457';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/d2459787-dcc3-4b93-b909-cd59afefb457');
  }
