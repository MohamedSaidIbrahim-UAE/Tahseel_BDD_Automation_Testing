/**
 * PaymentCardStatisticReport Page Object Model
 * 
 * Module: Payment Card Statistic Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/36c293e5-2afa-4e20-be10-a718bd20de2f
 * 
 * This POM class encapsulates all interactions with the Payment Card Statistic Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module PaymentCardStatisticReport
 */
...
/**
 * PaymentCardStatisticReport
 * 
 * Provides page object methods for Payment Card Statistic Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new PaymentCardStatisticReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class PaymentCardStatisticReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Payment Card Statistic Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/36c293e5-2afa-4e20-be10-a718bd20de2f';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/36c293e5-2afa-4e20-be10-a718bd20de2f');
  }
