/**
 * ViewAllLoadRequests Page Object Model
 * 
 * Module: View All Load Requests
 * URL: https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/all-load-requests-list
 * 
 * This POM class encapsulates all interactions with the View All Load Requests module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module ViewAllLoadRequests
 */
 ...
 * ViewAllLoadRequests
 * 
 * Provides page object methods for View All Load Requests module.
 * 
 * Usage:
 * ```typescript
 * const page = new ViewAllLoadRequests(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class ViewAllLoadRequests extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'View All Load Requests';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/all-load-requests-list';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/all-load-requests-list');
  }
