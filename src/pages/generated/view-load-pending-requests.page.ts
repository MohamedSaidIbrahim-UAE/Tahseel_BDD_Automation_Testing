/**
 * ViewLoadPendingRequests Page Object Model
 * 
 * Module: View Load Pending Requests
 * URL: https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/pending-load-requests-list
 * 
 * This POM class encapsulates all interactions with the View Load Pending Requests module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module ViewLoadPendingRequests
 */
...
/**
 * ViewLoadPendingRequests
 * 
 * Provides page object methods for View Load Pending Requests module.
 * 
 * Usage:
 * ```typescript
 * const page = new ViewLoadPendingRequests(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class ViewLoadPendingRequests extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'View Load Pending Requests';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/pending-load-requests-list';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/pending-load-requests-list');
  }
