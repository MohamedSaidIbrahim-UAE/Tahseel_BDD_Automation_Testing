/**
 * TahseelCards Page Object Model
 * 
 * Module: Tahseel Cards
 * URL: https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/8
 * 
 * This POM class encapsulates all interactions with the Tahseel Cards module.
 ...
 * TahseelCards
 * 
 * Provides page object methods for Tahseel Cards module.
 * 
 * Usage:
 * ```typescript
 * const page = new TahseelCards(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TahseelCards extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Tahseel Cards';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/8';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/business-intelligence/dashborad/8');
  }
