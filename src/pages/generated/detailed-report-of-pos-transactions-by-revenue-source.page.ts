/**
 * DetailedReportOfPosTransactionsByRevenueSource Page Object Model
 * 
 * Module: Detailed Report of POS Transactions by Revenue Source
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/da6263af-4818-4b0c-93cd-eafcd446ba5e
 * 
 * This POM class encapsulates all interactions with the Detailed Report of POS Transactions by Revenue Source module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DetailedReportOfPosTransactionsByRevenueSource
 */
...
/**
 * DetailedReportOfPosTransactionsByRevenueSource
 * 
 * Provides page object methods for Detailed Report of POS Transactions by Revenue Source module.
 * 
 * Usage:
 * ```typescript
 * const page = new DetailedReportOfPosTransactionsByRevenueSource(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DetailedReportOfPosTransactionsByRevenueSource extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Detailed Report of POS Transactions by Revenue Source';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/da6263af-4818-4b0c-93cd-eafcd446ba5e';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/da6263af-4818-4b0c-93cd-eafcd446ba5e');
  }
