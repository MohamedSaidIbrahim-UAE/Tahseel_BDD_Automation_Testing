/**
 * SummeryLoadingReport Page Object Model
 * 
 * Module: Summery Loading Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/46f4addf-afe5-48a4-a4bc-8d486026840c
 * 
 * This POM class encapsulates all interactions with the Summery Loading Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SummeryLoadingReport
 */
...
/**
 * SummeryLoadingReport
 * 
 * Provides page object methods for Summery Loading Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new SummeryLoadingReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SummeryLoadingReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Summery Loading Report';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/46f4addf-afe5-48a4-a4bc-8d486026840c');
  }
