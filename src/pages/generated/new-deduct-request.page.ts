/**
 * NewDeductRequest Page Object Model
 * 
 * Module: New Deduct Request
 * URL: https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/deduct-requests
 * 
 * This POM class encapsulates all interactions with the New Deduct Request module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module NewDeductRequest
 */
 ...
 * NewDeductRequest
 * 
 * Provides page object methods for New Deduct Request module.
 * 
 * Usage:
 * ```typescript
 * const page = new NewDeductRequest(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class NewDeductRequest extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'New Deduct Request';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/deduct-requests';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/deduct-requests');
  }
