/**
 * SfdDetailedWalletsTransactionsReport Page Object Model
 * 
 * Module: SFD Detailed Wallets Transactions Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/c7427897-5abd-4743-9cab-9c4d1fa5039c
 * 
 * This POM class encapsulates all interactions with the SFD Detailed Wallets Transactions Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SfdDetailedWalletsTransactionsReport
 */
...
/**
 * SfdDetailedWalletsTransactionsReport
 * 
 * Provides page object methods for SFD Detailed Wallets Transactions Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new SfdDetailedWalletsTransactionsReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SfdDetailedWalletsTransactionsReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'SFD Detailed Wallets Transactions Report';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/c7427897-5abd-4743-9cab-9c4d1fa5039c');
  }
