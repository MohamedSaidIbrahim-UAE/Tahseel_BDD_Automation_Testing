/**
 * ExhibitionsAndEvents Page Object Model
 * 
 * Module: Exhibitions and events
 * URL: https://staging.tahseel.gov.ae/ManagePortal/exhibition/exhibitions
 * 
 * This POM class encapsulates all interactions with the Exhibitions and events module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module ExhibitionsAndEvents
 */
 ...
 * 
 * Provides page object methods for Exhibitions and events module.
 * 
 * Usage:
 * ```typescript
 * const page = new ExhibitionsAndEvents(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class ExhibitionsAndEvents extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Exhibitions and events';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/exhibition/exhibitions';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/exhibition/exhibitions');
  }
