/**
 * SharjahIslamicBankSettlementReport Page Object Model
 * 
 * Module: Sharjah islamic bank settlement report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/513e8db8-feab-4d35-9fec-5e420a23d6ec
 * 
 * This POM class encapsulates all interactions with the Sharjah islamic bank settlement report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SharjahIslamicBankSettlementReport
 */
...
/**
 * SharjahIslamicBankSettlementReport
 * 
 * Provides page object methods for Sharjah islamic bank settlement report module.
 * 
 * Usage:
 * ```typescript
 * const page = new SharjahIslamicBankSettlementReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SharjahIslamicBankSettlementReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Sharjah islamic bank settlement report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/513e8db8-feab-4d35-9fec-5e420a23d6ec';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/513e8db8-feab-4d35-9fec-5e420a23d6ec');
  }
