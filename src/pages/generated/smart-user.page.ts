/**
 * SmartUser Page Object Model
 * 
 * Module: Smart User
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/smart-users
 * 
 * This POM class encapsulates all interactions with the Smart User module.
 ...
 * SmartUser
 * 
 * Provides page object methods for Smart User module.
 * 
 * Usage:
 * ```typescript
 * const page = new SmartUser(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SmartUser extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Smart User';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/smart-users';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/smart-users');
  }
