/**
 * EVoucherReportTransaction Page Object Model
 * 
 * Module: E-Voucher Report Transaction
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/51b66814-9d0b-4198-a129-b7cb38dd0978
 * 
 * This POM class encapsulates all interactions with the E-Voucher Report Transaction module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module EVoucherReportTransaction
 */
...
/**
 * EVoucherReportTransaction
 * 
 * Provides page object methods for E-Voucher Report Transaction module.
 * 
 * Usage:
 * ```typescript
 * const page = new EVoucherReportTransaction(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class EVoucherReportTransaction extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'E-Voucher Report Transaction';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/51b66814-9d0b-4198-a129-b7cb38dd0978';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/51b66814-9d0b-4198-a129-b7cb38dd0978');
  }
