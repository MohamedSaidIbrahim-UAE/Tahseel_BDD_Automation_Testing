/**
 * EVocuherLoadingReport Page Object Model
 * 
 * Module: E-Vocuher Loading Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/7b3cd636-866a-4721-9b5a-c93441c85e90
 * 
 * This POM class encapsulates all interactions with the E-Vocuher Loading Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module EVocuherLoadingReport
 */
...
/**
 * EVocuherLoadingReport
 * 
 * Provides page object methods for E-Vocuher Loading Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new EVocuherLoadingReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class EVocuherLoadingReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'E-Vocuher Loading Report';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/7b3cd636-866a-4721-9b5a-c93441c85e90');
  }
