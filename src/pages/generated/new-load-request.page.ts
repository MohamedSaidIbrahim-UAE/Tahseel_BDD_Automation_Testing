/**
 * NewLoadRequest Page Object Model
 * 
 * Module: New Load Request
 * URL: https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/load-requests
 * 
 * This POM class encapsulates all interactions with the New Load Request module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module NewLoadRequest
 */
 ...
 * NewLoadRequest
 * 
 * Provides page object methods for New Load Request module.
 * 
 * Usage:
 * ```typescript
 * const page = new NewLoadRequest(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class NewLoadRequest extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'New Load Request';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/load-requests';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/load-and-deduct-balance/load-requests');
  }
