/**
 * SummarySeddTransactionsReport Page Object Model
 * 
 * Module: Summary SEDD Transactions Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/855930f8-1ac7-43be-b39d-162610d1d61e
 * 
 * This POM class encapsulates all interactions with the Summary SEDD Transactions Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SummarySeddTransactionsReport
 */
...
/**
 * SummarySeddTransactionsReport
 * 
 * Provides page object methods for Summary SEDD Transactions Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new SummarySeddTransactionsReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SummarySeddTransactionsReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Summary SEDD Transactions Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/855930f8-1ac7-43be-b39d-162610d1d61e';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/855930f8-1ac7-43be-b39d-162610d1d61e');
  }
