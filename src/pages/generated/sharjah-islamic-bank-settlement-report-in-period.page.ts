/**
 * SharjahIslamicBankSettlementReportInPeriod Page Object Model
 * 
 * Module: Sharjah islamic bank settlement report in period
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/01620815-ad1b-439a-8b28-498d7ab563f6
 * 
 * This POM class encapsulates all interactions with the Sharjah islamic bank settlement report in period module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SharjahIslamicBankSettlementReportInPeriod
 */
...
/**
 * SharjahIslamicBankSettlementReportInPeriod
 * 
 * Provides page object methods for Sharjah islamic bank settlement report in period module.
 * 
 * Usage:
 * ```typescript
 * const page = new SharjahIslamicBankSettlementReportInPeriod(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SharjahIslamicBankSettlementReportInPeriod extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Sharjah islamic bank settlement report in period';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/01620815-ad1b-439a-8b28-498d7ab563f6';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/01620815-ad1b-439a-8b28-498d7ab563f6');
  }
