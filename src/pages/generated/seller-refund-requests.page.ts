/**
 * SellerRefundRequests Page Object Model
 * 
 * Module: Seller Refund Requests
 * URL: https://staging.tahseel.gov.ae/ManagePortal/seller-deposite/action
 * 
 * This POM class encapsulates all interactions with the Seller Refund Requests module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module SellerRefundRequests
 */
 ...
 * 
 * Provides page object methods for Seller Refund Requests module.
 * 
 * Usage:
 * ```typescript
 * const page = new SellerRefundRequests(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SellerRefundRequests extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Seller Refund Requests';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/seller-deposite/action';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/seller-deposite/action');
  }
