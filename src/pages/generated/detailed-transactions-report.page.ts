/**
 * DetailedTransactionsReport Page Object Model
 * 
 * Module: Detailed Transactions Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/a83c556e-1ab9-490e-a010-50976bb96427
 * 
 * This POM class encapsulates all interactions with the Detailed Transactions Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DetailedTransactionsReport
 */
...
/**
 * DetailedTransactionsReport
 * 
 * Provides page object methods for Detailed Transactions Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new DetailedTransactionsReport(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DetailedTransactionsReport extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Detailed Transactions Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/a83c556e-1ab9-490e-a010-50976bb96427';
  ...
  readonly selectors: Record<string, string> = {
    ...
    remote_paymentField: '[aria-label="Remote Payment"], label:has-text("Remote Payment") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/a83c556e-1ab9-490e-a010-50976bb96427');
  }
