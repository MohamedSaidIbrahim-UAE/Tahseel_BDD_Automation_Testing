 ...
 * 
 * Module: Home
 * URL: https://staging.tahseel.gov.ae/ManagePortal/dashboard
 * 
 * This POM class encapsulates all interactions with the Home module.
 ...
 * Home
 * 
 * Provides page object methods for Home module.
 * 
 * Usage:
 * ```typescript
 * const page = new Home(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class Home extends BaseListPage {
  /**
   ...
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/dashboard';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/dashboard');
  }
