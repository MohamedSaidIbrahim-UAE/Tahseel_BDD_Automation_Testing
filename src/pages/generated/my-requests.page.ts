/**
 * MyRequests Page Object Model
 * 
 * Module: My Requests
 * URL: https://staging.tahseel.gov.ae/ManagePortal/transactioncancel/action
 * 
 * This POM class encapsulates all interactions with the My Requests module.
 ...
 * MyRequests
 * 
 * Provides page object methods for My Requests module.
 * 
 * Usage:
 * ```typescript
 * const page = new MyRequests(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class MyRequests extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'My Requests';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/transactioncancel/action';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/transactioncancel/action');
  }
