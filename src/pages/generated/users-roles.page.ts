/**
 * UsersRoles Page Object Model
 * 
 * Module: Users Roles
 * URL: https://staging.tahseel.gov.ae/ManagePortal/role
 * 
 * This POM class encapsulates all interactions with the Users Roles module.
 ...
 * UsersRoles
 * 
 * Provides page object methods for Users Roles module.
 * 
 * Usage:
 * ```typescript
 * const page = new UsersRoles(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class UsersRoles extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Users Roles';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/role';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/role');
  }
