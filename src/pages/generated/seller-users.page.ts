/**
 * SellerUsers Page Object Model
 * 
 * Module: Seller Users
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/seller-users
 * 
 * This POM class encapsulates all interactions with the Seller Users module.
 ...
 * SellerUsers
 * 
 * Provides page object methods for Seller Users module.
 * 
 * Usage:
 * ```typescript
 * const page = new SellerUsers(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class SellerUsers extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Seller Users';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/seller-users';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/seller-users');
  }
