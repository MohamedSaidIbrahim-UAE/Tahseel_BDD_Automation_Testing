/**
 * StuckRefundRequests Page Object Model
 * 
 * Module: Stuck Refund Requests
 * URL: https://staging.tahseel.gov.ae/ManagePortal/refund/bank-nonexisting-refundrequests
 * 
 * This POM class encapsulates all interactions with the Stuck Refund Requests module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module StuckRefundRequests
 */
 ...
 * StuckRefundRequests
 * 
 * Provides page object methods for Stuck Refund Requests module.
 * 
 * Usage:
 * ```typescript
 * const page = new StuckRefundRequests(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class StuckRefundRequests extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Stuck Refund Requests';
  ...
  readonly selectors: Record<string, string> = {
    ...
    pending_refund_bill_requestsField: '[aria-label="Pending Refund Bill Requests"], label:has-text("Pending Refund Bill Requests") ~ input',
    pending_deposit_refund_requestsField: '[aria-label="Pending Deposit Refund Requests"], label:has-text("Pending Deposit Refund Requests") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/refund/bank-nonexisting-refundrequests');
  }
