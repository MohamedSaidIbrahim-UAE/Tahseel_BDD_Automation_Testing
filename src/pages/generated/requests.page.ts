 ...
 * 
 * Module: Requests
 * URL: https://staging.tahseel.gov.ae/ManagePortal/tahseelcard
 * 
 * This POM class encapsulates all interactions with the Requests module.
 ...
 * Requests
 * 
 * Provides page object methods for Requests module.
 * 
 * Usage:
 * ```typescript
 * const page = new Requests(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class Requests extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Requests';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/tahseelcard';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/tahseelcard');
  }
