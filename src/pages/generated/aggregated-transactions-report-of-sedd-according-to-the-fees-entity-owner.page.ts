/**
 * AggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner Page Object Model
 * 
 * Module: Aggregated transactions report of SEDD According to the Fees entity owner
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/51db49b0-c098-4808-8b29-bb868671abba
 * 
 * This POM class encapsulates all interactions with the Aggregated transactions report of SEDD According to the Fees entity owner module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module AggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner
 */
...
/**
 * AggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner
 * 
 * Provides page object methods for Aggregated transactions report of SEDD According to the Fees entity owner module.
 * 
 * Usage:
 * ```typescript
 * const page = new AggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class AggregatedTransactionsReportOfSeddAccordingToTheFeesEntityOwner extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Aggregated transactions report of SEDD According to the Fees entity owner';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/51db49b0-c098-4808-8b29-bb868671abba');
  }
