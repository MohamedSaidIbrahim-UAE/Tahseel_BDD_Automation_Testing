/**
 * BookPublisherDevices Page Object Model
 * 
 * Module: Book Publisher Devices
 * URL: https://staging.tahseel.gov.ae/ManagePortal/exhibition/device-handover
 * 
 * This POM class encapsulates all interactions with the Book Publisher Devices module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module BookPublisherDevices
 */
...
/**
 * BookPublisherDevices
 * 
 * Provides page object methods for Book Publisher Devices module.
 * 
 * Usage:
 * ```typescript
 * const page = new BookPublisherDevices(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class BookPublisherDevices extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Book Publisher Devices';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/exhibition/device-handover';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/exhibition/device-handover');
  }
