 ...
 * 
 * Module: FORMS
 * URL: https://staging.tahseel.gov.ae/ManagePortal/forms
 * 
 * This POM class encapsulates all interactions with the FORMS module.
 ...
 * Forms
 * 
 * Provides page object methods for FORMS module.
 * 
 * Usage:
 * ```typescript
 * const page = new Forms(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class Forms extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'FORMS';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/forms';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/forms');
  }
