/**
 * TahseelAccountDeductLoadReqeust Page Object Model
 * 
 * Module: Tahseel Account Deduct & Load Reqeust
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/f6239423-7124-4080-9b03-b47feec33ec0
 * 
 * This POM class encapsulates all interactions with the Tahseel Account Deduct & Load Reqeust module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TahseelAccountDeductLoadReqeust
 */
...
/**
 * TahseelAccountDeductLoadReqeust
 * 
 * Provides page object methods for Tahseel Account Deduct & Load Reqeust module.
 * 
 * Usage:
 * ```typescript
 * const page = new TahseelAccountDeductLoadReqeust(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TahseelAccountDeductLoadReqeust extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Tahseel Account Deduct & Load Reqeust';
  ...
  readonly selectors: Record<string, string> = {
    ...
    accountkeyField: '[aria-label="AccountKey"], label:has-text("AccountKey") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/f6239423-7124-4080-9b03-b47feec33ec0');
  }
