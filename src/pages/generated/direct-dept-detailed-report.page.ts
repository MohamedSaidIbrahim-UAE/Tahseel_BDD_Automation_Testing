/**
 * DirectDeptDetailedReport Page Object Model
 * 
 * Module: Direct Dept Detailed Report
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/fd9ab401-b01d-4514-b416-521d750fa06c
 * 
 * This POM class encapsulates all interactions with the Direct Dept Detailed Report module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DirectDeptDetailedReport
 */
...
/**
 * DirectDeptDetailedReport
 * 
 * Provides page object methods for Direct Dept Detailed Report module.
 * 
 * Usage:
 * ```typescript
 * const page = new DirectDeptDetailedReport(playwrightPage);
...
export class DirectDeptDetailedReport extends BasePage {
   ...
   */
  readonly moduleName = 'Direct Dept Detailed Report';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/fd9ab401-b01d-4514-b416-521d750fa06c';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/fd9ab401-b01d-4514-b416-521d750fa06c');
  }
