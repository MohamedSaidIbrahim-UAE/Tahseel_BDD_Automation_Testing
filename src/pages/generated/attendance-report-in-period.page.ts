/**
 * AttendanceReportInPeriod Page Object Model
 * 
 * Module: attendance report in period
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/847d57bd-30b6-4274-a416-653de00438ee
 * 
 * This POM class encapsulates all interactions with the attendance report in period module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module AttendanceReportInPeriod
 */
...
/**
 * AttendanceReportInPeriod
 * 
 * Provides page object methods for attendance report in period module.
 * 
 * Usage:
 * ```typescript
 * const page = new AttendanceReportInPeriod(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class AttendanceReportInPeriod extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'attendance report in period';
  ...
  readonly selectors: Record<string, string> = {
    ...
    _Field: '[aria-label="اسم الموظف"], label:has-text("اسم الموظف") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/847d57bd-30b6-4274-a416-653de00438ee');
  }
