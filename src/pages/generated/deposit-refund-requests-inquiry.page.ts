/**
 * DepositRefundRequestsInquiry Page Object Model
 * 
 * Module: Deposit Refund Requests Inquiry
 * URL: https://staging.tahseel.gov.ae/ManagePortal/deposits/deposit-requests
 * 
 * This POM class encapsulates all interactions with the Deposit Refund Requests Inquiry module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DepositRefundRequestsInquiry
 */
...
/**
 * DepositRefundRequestsInquiry
 * 
 * Provides page object methods for Deposit Refund Requests Inquiry module.
 * 
 * Usage:
 * ```typescript
 * const page = new DepositRefundRequestsInquiry(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DepositRefundRequestsInquiry extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Deposit Refund Requests Inquiry';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/deposits/deposit-requests';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/deposits/deposit-requests');
  }
