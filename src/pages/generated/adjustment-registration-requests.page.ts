/**
 * AdjustmentRegistrationRequests Page Object Model
 * 
 * Module: Adjustment Registration Requests
 * URL: https://staging.tahseel.gov.ae/ManagePortal/adjustment-registeration/adjustment-registeration-requests
 * 
 * This POM class encapsulates all interactions with the Adjustment Registration Requests module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module AdjustmentRegistrationRequests
 */
...
/**
 * AdjustmentRegistrationRequests
 * 
 * Provides page object methods for Adjustment Registration Requests module.
 * 
 * Usage:
 * ```typescript
 * const page = new AdjustmentRegistrationRequests(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class AdjustmentRegistrationRequests extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Adjustment Registration Requests';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/adjustment-registeration/adjustment-registeration-requests';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/adjustment-registeration/adjustment-registeration-requests');
  }
