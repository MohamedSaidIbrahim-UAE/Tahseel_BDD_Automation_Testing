/**
 * InquireTopupTransaction Page Object Model
 * 
 * Module: Inquire Topup Transaction
 * URL: https://staging.tahseel.gov.ae/ManagePortal/top-up/inquiry
 * 
 * This POM class encapsulates all interactions with the Inquire Topup Transaction module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module InquireTopupTransaction
 */
...
/**
 * InquireTopupTransaction
 * 
 * Provides page object methods for Inquire Topup Transaction module.
 * 
 * Usage:
 * ```typescript
 * const page = new InquireTopupTransaction(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class InquireTopupTransaction extends BaseFormPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Inquire Topup Transaction';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/top-up/inquiry');
  }
