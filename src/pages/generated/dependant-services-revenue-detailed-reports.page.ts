/**
 * DependantServicesRevenueDetailedReports Page Object Model
 * 
 * Module: Dependant services revenue detailed reports
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/66877a90-23a3-4737-ab5a-44cca07fe69d
 * 
 * This POM class encapsulates all interactions with the Dependant services revenue detailed reports module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module DependantServicesRevenueDetailedReports
 */
...
/**
 * DependantServicesRevenueDetailedReports
 * 
 * Provides page object methods for Dependant services revenue detailed reports module.
 * 
 * Usage:
 * ```typescript
 * const page = new DependantServicesRevenueDetailedReports(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class DependantServicesRevenueDetailedReports extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Dependant services revenue detailed reports';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/66877a90-23a3-4737-ab5a-44cca07fe69d';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/66877a90-23a3-4737-ab5a-44cca07fe69d');
  }
