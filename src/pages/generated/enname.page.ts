/**
 * Enname Page Object Model
 * 
 * Module: enName
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/fa9e9a3b-7593-4245-85e0-0ada650f7821
 * 
 * This POM class encapsulates all interactions with the enName module.
 ...
 * Enname
 * 
 * Provides page object methods for enName module.
 * 
 * Usage:
 * ```typescript
 * const page = new Enname(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class Enname extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'enName';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/report-show/fa9e9a3b-7593-4245-85e0-0ada650f7821';
  ...
  readonly selectors: Record<string, string> = {
    ...
    other_departmentField: '[aria-label="Other Department"], label:has-text("Other Department") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/fa9e9a3b-7593-4245-85e0-0ada650f7821');
  }
