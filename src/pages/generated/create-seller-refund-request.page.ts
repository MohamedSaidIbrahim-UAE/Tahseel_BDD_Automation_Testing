/**
 * CreateSellerRefundRequest Page Object Model
 * 
 * Module: Create Seller Refund Request
 * URL: https://staging.tahseel.gov.ae/ManagePortal/seller-deposite/create
 * 
 * This POM class encapsulates all interactions with the Create Seller Refund Request module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module CreateSellerRefundRequest
 */
...
/**
 * CreateSellerRefundRequest
 * 
 * Provides page object methods for Create Seller Refund Request module.
 * 
 * Usage:
 * ```typescript
 * const page = new CreateSellerRefundRequest(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class CreateSellerRefundRequest extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Create Seller Refund Request';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/seller-deposite/create';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/seller-deposite/create');
  }
