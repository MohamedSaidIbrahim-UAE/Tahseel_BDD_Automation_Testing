/**
 * BankTransfersOfSharjahIslamicBankGeneral Page Object Model
 * 
 * Module: Bank transfers of Sharjah Islamic Bank General
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/bd57abb9-56e9-4559-9e1b-0654e91e454c
 * 
 * This POM class encapsulates all interactions with the Bank transfers of Sharjah Islamic Bank General module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module BankTransfersOfSharjahIslamicBankGeneral
 */
...
/**
 * BankTransfersOfSharjahIslamicBankGeneral
 * 
 * Provides page object methods for Bank transfers of Sharjah Islamic Bank General module.
 * 
 * Usage:
 * ```typescript
 * const page = new BankTransfersOfSharjahIslamicBankGeneral(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class BankTransfersOfSharjahIslamicBankGeneral extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Bank transfers of Sharjah Islamic Bank General';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/bd57abb9-56e9-4559-9e1b-0654e91e454c');
  }
