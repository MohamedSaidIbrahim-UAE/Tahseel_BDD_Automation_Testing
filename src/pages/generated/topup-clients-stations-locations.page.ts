/**
 * TopupClientsStationsLocations Page Object Model
 * 
 * Module: Topup Clients Stations Locations
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/topup-stations-locations
 * 
 * This POM class encapsulates all interactions with the Topup Clients Stations Locations module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TopupClientsStationsLocations
 */
...
/**
 * TopupClientsStationsLocations
 * 
 * Provides page object methods for Topup Clients Stations Locations module.
 * 
 * Usage:
 * ```typescript
 * const page = new TopupClientsStationsLocations(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TopupClientsStationsLocations extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Topup Clients Stations Locations';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/topup-stations-locations';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/topup-stations-locations');
  }
