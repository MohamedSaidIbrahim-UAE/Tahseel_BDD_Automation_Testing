/**
 * InquireSellerRefundRequest Page Object Model
 * 
 * Module: Inquire seller Refund Request
 * URL: https://staging.tahseel.gov.ae/ManagePortal/seller-deposite/inquire
 * 
 * This POM class encapsulates all interactions with the Inquire seller Refund Request module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module InquireSellerRefundRequest
 */
...
/**
 * InquireSellerRefundRequest
 * 
 * Provides page object methods for Inquire seller Refund Request module.
 * 
 * Usage:
 * ```typescript
 * const page = new InquireSellerRefundRequest(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class InquireSellerRefundRequest extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Inquire seller Refund Request';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/seller-deposite/inquire';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/seller-deposite/inquire');
  }
