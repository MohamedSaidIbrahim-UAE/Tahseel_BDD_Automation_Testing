/**
 * MerchantUsers Page Object Model
 * 
 * Module: Merchant Users
 * URL: https://staging.tahseel.gov.ae/ManagePortal/system-users/merchant-users/departments-list
 * 
 * This POM class encapsulates all interactions with the Merchant Users module.
 ...
 * MerchantUsers
 * 
 * Provides page object methods for Merchant Users module.
 * 
 * Usage:
 * ```typescript
 * const page = new MerchantUsers(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class MerchantUsers extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Merchant Users';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/system-users/merchant-users/departments-list';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/system-users/merchant-users/departments-list');
  }
