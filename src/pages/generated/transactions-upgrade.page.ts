/**
 * TransactionsUpgrade Page Object Model
 * 
 * Module: Transactions Upgrade
 * URL: https://staging.tahseel.gov.ae/ManagePortal/transactions/transactions-eligible-for-upgrade
 * 
 * This POM class encapsulates all interactions with the Transactions Upgrade module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module TransactionsUpgrade
 */
 ...
 * TransactionsUpgrade
 * 
 * Provides page object methods for Transactions Upgrade module.
 * 
 * Usage:
 * ```typescript
 * const page = new TransactionsUpgrade(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class TransactionsUpgrade extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Transactions Upgrade';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/transactions/transactions-eligible-for-upgrade';

  readonly selectors: Record<string, string> = {
    mainContainer: '[data-module], main, [role="main"]',
    // Form fields
    transactions_upgradeField: '[aria-label="Transactions Upgrade"], label:has-text("Transactions Upgrade") ~ input',
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/transactions/transactions-eligible-for-upgrade');
  }
