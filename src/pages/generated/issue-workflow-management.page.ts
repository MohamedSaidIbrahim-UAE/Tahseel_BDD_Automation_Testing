/**
 * IssueWorkflowManagement Page Object Model
 * 
 * Module: Issue Workflow Management
 * URL: https://staging.tahseel.gov.ae/ManagePortal/workflowManag/issueworkflow
 * 
 * This POM class encapsulates all interactions with the Issue Workflow Management module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module IssueWorkflowManagement
 */
 ...
 * 
 * Provides page object methods for Issue Workflow Management module.
 * 
 * Usage:
 * ```typescript
 * const page = new IssueWorkflowManagement(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class IssueWorkflowManagement extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'Issue Workflow Management';

  /**
   * Module URL from audit data
   */
  readonly moduleUrl = 'https://staging.tahseel.gov.ae/ManagePortal/workflowManag/issueworkflow';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/workflowManag/issueworkflow');
  }
