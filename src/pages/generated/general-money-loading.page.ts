/**
 * GeneralMoneyLoading Page Object Model
 * 
 * Module: General Money Loading
 * URL: https://staging.tahseel.gov.ae/ManagePortal/report-show/f23b2250-8124-430b-a703-5845100a806f
 * 
 * This POM class encapsulates all interactions with the General Money Loading module.
 * Extends BasePage to inherit common functionality and utilities.
 * 
 * @category Page Objects
 * @module GeneralMoneyLoading
 */
 ...
 * GeneralMoneyLoading
 * 
 * Provides page object methods for General Money Loading module.
 * 
 * Usage:
 * ```typescript
 * const page = new GeneralMoneyLoading(playwrightPage);
 * await page.navigateToModule();
 * await page.verifyPageLoaded();
 * ```
 */
export class GeneralMoneyLoading extends BaseListPage {
  /**
   * Module name for identification
   */
  readonly moduleName = 'General Money Loading';
  ...
  async navigateToModule(): Promise<void> {
    ...
    await this.navigateToUrl('https://staging.tahseel.gov.ae/ManagePortal/report-show/f23b2250-8124-430b-a703-5845100a806f');
  }
