Feature: Total Transactions Report by Deposit Entity
  ...
  Background:
    ...
    And deposit entities "Civil Aviation" and "Entity-B" are active
  ...
  Scenario: Mixed transactions summarised per entity
    Given the following transactions are posted:
      | Entity   | Type    | Amount |
      | Civil Aviation | Deposit | 10000  |
      | Civil Aviation | Refund  | 2000   |
      | Civil Aviation | Retain  | 1000   |
    ...
    Then the report displays:
      ...
      | Civil Aviation | 10000.00       | 2000.00       | 1000.00       | 7000.00    |
  ...
  Scenario: Entity-restricted user sees only own entity totals
    ...
    Then only the row for Civil Aviation appears
