Feature: Departments - Module management and operations
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Code, English Name, ]Department Type
