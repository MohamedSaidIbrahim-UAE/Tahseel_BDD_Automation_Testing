# Feature: IBAN Registration Requests - Page heading mismatch for "IBAN Registration Requests"
  
  As a user
  I want to interact with the IBAN Registration Requests module
  So that I can manage and track page heading mismatch for "iban registration requests"


  Background:
    Given the user is authenticated
    And the user navigates to the "IBAN Registration Requests" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "IBAN Registration Requests"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Registration Number, Department, Account Name
