Feature: IBAN Registration Pending Requests - Page heading mismatch for "IBAN Registration Pending Requests"
  ...
  So that I can manage and track page heading mismatch for "iban registration pending requests"


  Background:
    Given the user is authenticated
    And the user navigates to the "IBAN Registration Pending Requests" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "IBAN Registration Pending Requests"
