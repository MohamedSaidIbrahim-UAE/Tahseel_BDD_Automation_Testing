# Feature: Workflows - Page heading mismatch for "Workflows"
  
  As a user
  I want to interact with the Workflows module
  So that I can manage and track page heading mismatch for "workflows"


  Background:
    Given the user is authenticated
    And the user navigates to the "Workflows" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Workflows"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: English Name, Workflow Type, Department
