Feature: Transaction Fees For All Payment Methods - Entity
  ...
  Background:
    ...
    And the user navigates to the "Transaction Fees For All Payment Methods" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Transaction Fees For All Payment Methods"
