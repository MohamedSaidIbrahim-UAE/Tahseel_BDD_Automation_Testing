Feature: Total Transactions Report By Revenue Entity - Entity
  
  As a user
  I want to interact with the Total Transactions Report By Revenue Entity module
  So that I can manage and track entity


  Background:
    Given the user is authenticated
    And the user navigates to the "Total Transactions Report By Revenue Entity" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Total Transactions Report By Revenue Entity"
