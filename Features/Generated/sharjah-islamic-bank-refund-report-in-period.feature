Feature: Sharjah Islamic Bank Refund Report In Period - From Date
  ...
  Background:
    ...
    And the user navigates to the "Sharjah Islamic Bank Refund Report In Period" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Sharjah Islamic Bank Refund Report In Period"
