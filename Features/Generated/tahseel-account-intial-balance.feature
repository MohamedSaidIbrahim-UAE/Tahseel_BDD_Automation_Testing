Feature: Tahseel Account Intial Balance - AccountType
  ...
  So that I can manage and track accounttype


  Background:
    Given the user is authenticated
    And the user navigates to the "Tahseel Account Intial Balance" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Tahseel Account Intial Balance"
