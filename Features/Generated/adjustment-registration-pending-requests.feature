Feature: Adjustment Registration Pending Requests - Module management and operations
  ...
  Background:
    ...
    And the user navigates to the "Adjustment Registration Pending Requests" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Adjustment Registration Pending Requests"
