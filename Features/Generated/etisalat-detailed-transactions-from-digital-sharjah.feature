Feature: Etisalat Detailed Transactions From Digital Sharjah - Service Type
  ...
  So that I can manage and track service type

  Background:
    Given the user is authenticated
    And the user navigates to the "Etisalat Detailed Transactions From Digital Sharjah" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Etisalat Detailed Transactions From Digital Sharjah"
