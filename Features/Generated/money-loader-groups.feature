# Feature: Money Loader Groups - Page heading mismatch for "Money Loader Groups"
  ...
  So that I can manage and track page heading mismatch for "money loader groups"


  Background:
    Given the user is authenticated
    And the user navigates to the "Money Loader Groups" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Money Loader Groups"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: English Name, Active, Actions
