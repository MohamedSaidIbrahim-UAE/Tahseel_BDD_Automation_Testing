Feature: Service Rules - Module management and operations
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Department, Arabic Name, English Name
