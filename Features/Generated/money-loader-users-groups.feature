Feature: Money Loader Users Groups - Page heading mismatch for "Money Loader Users Groups"
  As a user
  I want to interact with the Money Loader Users Groups module
  So that I can manage and track page heading mismatch for "money loader users groups"

  Background:
    Given the user is authenticated
    And the user navigates to the "Money Loader Users Groups" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Money Loader Users Groups"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: English Name, Loader ID, Deduct Caller ID
