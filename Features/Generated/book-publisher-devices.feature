Feature: Book Publisher Devices - Module management and operations
  ...
  Background:
    ...
    And the user navigates to the "Book Publisher Devices" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Book Publisher Devices"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Exhibition Show, Publishing House, Device
