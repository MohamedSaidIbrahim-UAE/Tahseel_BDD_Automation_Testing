Feature: Publishing Houses - Module management and operations
  ...
  Background:
    ...
    And the user navigates to the "Publishing Houses" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Publishing Houses"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: English Name, Country English Name, Publisher Code
