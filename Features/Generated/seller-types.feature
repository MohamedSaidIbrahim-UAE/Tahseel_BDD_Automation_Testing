# Feature: Seller Types - Module management and operations
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Type Number, English Name, Active
