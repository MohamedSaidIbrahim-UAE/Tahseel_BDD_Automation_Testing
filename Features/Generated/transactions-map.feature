Feature: Transactions Map - Page heading mismatch for "Transactions Map"
  ...
  So that I can manage and track page heading mismatch for "transactions map"

  Background:
    Given the user is authenticated
    And the user navigates to the "Transactions Map" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Transactions Map"
