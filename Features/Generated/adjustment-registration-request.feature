# Feature: Adjustment Registration Request - Page heading mismatch for "Adjustment Registration Request"
  ...
  So that I can manage and track page heading mismatch for "adjustment registration request"


  Background:
    Given the user is authenticated
    And the user navigates to the "Adjustment Registration Request" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Adjustment Registration Request"
