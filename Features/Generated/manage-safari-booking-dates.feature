Feature: Manage Safari Booking Dates - Page heading mismatch for "Manage Safari Booking Dates"
  ...
  So that I can manage and track page heading mismatch for "manage safari booking dates"


  Background:
    Given the user is authenticated
    And the user navigates to the "Manage Safari Booking Dates" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Manage Safari Booking Dates"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: From Date, To Date, Notes
