Feature: Inquire Transactions - Page heading mismatch for "Inquire Transactions"
  ...
  So that I can manage and track page heading mismatch for "inquire transactions"

  Background:
    Given the user is authenticated
    And the user navigates to the "Inquire Transactions" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Inquire Transactions"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Tahseel Debit Card Name, Publisher Name, File Number
