# Feature: Intensive Settlement Details Report - Date
  ...
  So that I can manage and track date


  Background:
    Given the user is authenticated
    And the user navigates to the "Intensive Settlement Details Report" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Intensive Settlement Details Report"
