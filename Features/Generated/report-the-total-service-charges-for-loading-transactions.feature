# Feature: Report The Total Service Charges For Loading Transactions - From Date
  ...
  Background:
    ...
    And the user navigates to the "Report The Total Service Charges For Loading Transactions" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Report The Total Service Charges For Loading Transactions"
