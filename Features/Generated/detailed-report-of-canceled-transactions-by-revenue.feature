Feature: Detailed Report Of Canceled Transactions By Revenue - Entity
  ...
  As a user
  I want to interact with the Detailed Report Of Canceled Transactions By Revenue module
  So that I can manage and track entity


  Background:
    Given the user is authenticated
    And the user navigates to the "Detailed Report Of Canceled Transactions By Revenue" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Detailed Report Of Canceled Transactions By Revenue"
