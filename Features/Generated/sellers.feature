Feature: Sellers - Page heading mismatch for "Sellers"
  As a user
  I want to interact with the Sellers module
  So that I can manage and track page heading mismatch for "sellers"

  Background:
    Given the user is authenticated
    And the user navigates to the "Sellers" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Sellers"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: English Name, Department, Seller Type
