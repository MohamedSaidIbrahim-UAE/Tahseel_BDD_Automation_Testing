Feature: Detailed Report Of Canceled Transactions - Entity
  ...
  Background:
    ...
    And the user navigates to the "Detailed Report Of Canceled Transactions" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Detailed Report Of Canceled Transactions"
