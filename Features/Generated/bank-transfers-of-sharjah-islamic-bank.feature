# Feature: Bank Transfers Of Sharjah Islamic Bank - Entity
  
  As a user
  I want to interact with the Bank Transfers Of Sharjah Islamic Bank module
  So that I can manage and track entity


  Background:
    Given the user is authenticated
    And the user navigates to the "Bank Transfers Of Sharjah Islamic Bank" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Bank Transfers Of Sharjah Islamic Bank"
