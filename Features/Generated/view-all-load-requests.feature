Feature: View All Load Requests - Module management and operations
  As a user
  I want to interact with the View All Load Requests module
  So that I can manage and track module management and operations

  Background:
    Given the user is authenticated
    And the user navigates to the "View All Load Requests" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "View All Load Requests"
