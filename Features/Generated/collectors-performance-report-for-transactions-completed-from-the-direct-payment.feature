Feature: Collectors Performance Report For Transactions Completed From The Direct Payment - From
  ...
  So that I can manage and track from


  Background:
    Given the user is authenticated
    And the user navigates to the "Collectors Performance Report For Transactions Completed From The Direct Payment" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Collectors Performance Report For Transactions Completed From The Direct Payment"
