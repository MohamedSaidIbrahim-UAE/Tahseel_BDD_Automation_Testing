Feature: Topup Clients - Page heading mismatch for "Topup Clients"
  ...
  So that I can manage and track page heading mismatch for "topup clients"


  Background:
    Given the user is authenticated
    And the user navigates to the "Topup Clients" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Topup Clients"
