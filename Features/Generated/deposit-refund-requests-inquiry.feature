Feature: Deposit Refund Requests Inquiry - Page heading mismatch for "Deposit Refund Requests Inquiry"
  ...
  So that I can manage and track page heading mismatch for "deposit refund requests inquiry"

  Background:
    Given the user is authenticated
    And the user navigates to the "Deposit Refund Requests Inquiry" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Deposit Refund Requests Inquiry"
