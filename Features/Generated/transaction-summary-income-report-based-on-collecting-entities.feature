# Feature: Transaction Summary Income Report Based On Collecting Entities - Entity
  ...
  Background:
    ...
    And the user navigates to the "Transaction Summary Income Report Based On Collecting Entities" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Transaction Summary Income Report Based On Collecting Entities"
