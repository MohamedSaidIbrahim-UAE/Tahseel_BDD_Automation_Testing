Feature: Manage Adjustment Registeration Workflow - Module management and operations
  ...
  Background:
    ...
    And the user navigates to the "Manage Adjustment Registeration Workflow" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Manage Adjustment Registeration Workflow"
