# Feature: E Voucher Status Inquire Report - Entity
  
  As a user
  I want to interact with the E Voucher Status Inquire Report module
  So that I can manage and track entity


  Background:
    Given the user is authenticated
    And the user navigates to the "E Voucher Status Inquire Report" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "E Voucher Status Inquire Report"
