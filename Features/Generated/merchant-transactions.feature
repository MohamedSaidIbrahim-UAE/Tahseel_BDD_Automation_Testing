Feature: Merchant Transactions - Page heading mismatch for "Merchant Transactions"
  ...
  So that I can manage and track page heading mismatch for "merchant transactions"


  Background:
    Given the user is authenticated
    And the user navigates to the "Merchant Transactions" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Merchant Transactions"
