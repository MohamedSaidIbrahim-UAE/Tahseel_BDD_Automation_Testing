Feature: Money Loader User - Page heading mismatch for "Money Loader User"
  ...
  So that I can manage and track page heading mismatch for "money loader user"

  Background:
    Given the user is authenticated
    And the user navigates to the "Money Loader User" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Money Loader User"
