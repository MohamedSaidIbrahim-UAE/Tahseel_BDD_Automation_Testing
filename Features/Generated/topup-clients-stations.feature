Feature: Topup Clients Stations - Page heading mismatch for "Topup Clients Stations"
  As a user
  I want to interact with the Topup Clients Stations module
  So that I can manage and track page heading mismatch for "topup clients stations"

  Background:
    Given the user is authenticated
    And the user navigates to the "Topup Clients Stations" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Topup Clients Stations"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Client Key, State, Client Name
