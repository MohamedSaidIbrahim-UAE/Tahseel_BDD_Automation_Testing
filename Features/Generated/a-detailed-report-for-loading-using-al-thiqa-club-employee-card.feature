# Feature: A Detailed Report For Loading Using Al Thiqa Club Employee Card - اسم المستخدم
  ...
  So that I can manage and track اسم المستخدم


  Background:
    Given the user is authenticated
    And the user navigates to the "A Detailed Report For Loading Using Al Thiqa Club Employee Card" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "A Detailed Report For Loading Using Al Thiqa Club Employee Card"
