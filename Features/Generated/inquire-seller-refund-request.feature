Feature: Inquire Seller Refund Request - Module management and operations
  ...
  Background:
    ...
    And the user navigates to the "Inquire Seller Refund Request" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Inquire Seller Refund Request"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Reference Number, Department, Exhibition Show
