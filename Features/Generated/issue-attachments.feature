# Feature: Issue Attachments - Module management and operations
  ...
  Background:
    ...
    And the user navigates to the "Issue Attachments" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Issue Attachments"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: English Name, Categories, Format
