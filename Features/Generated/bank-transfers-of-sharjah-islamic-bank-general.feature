# Feature: Bank Transfers Of Sharjah Islamic Bank General - Entity
  ...
  Background:
    ...
    And the user navigates to the "Bank Transfers Of Sharjah Islamic Bank General" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Bank Transfers Of Sharjah Islamic Bank General"
