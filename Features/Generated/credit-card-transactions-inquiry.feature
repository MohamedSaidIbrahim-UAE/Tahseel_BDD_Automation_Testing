Feature: Credit Card Transactions Inquiry - Search Criteria
  ...
  Background:
    ...
    And the user navigates to the "Credit Card Transactions Inquiry" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Credit Card Transactions Inquiry"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Transaction Type, URL, Request
