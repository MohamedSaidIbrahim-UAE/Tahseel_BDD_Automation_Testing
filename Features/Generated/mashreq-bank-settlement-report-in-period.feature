# Feature: Mashreq Bank Settlement Report In Period - From Date
  ...
  Background:
    ...
    And the user navigates to the "Mashreq Bank Settlement Report In Period" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Mashreq Bank Settlement Report In Period"
