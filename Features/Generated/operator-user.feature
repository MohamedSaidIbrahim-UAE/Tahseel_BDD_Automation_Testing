Feature: Operator User - Page heading mismatch for "Operator User"
  ...
  So that I can manage and track page heading mismatch for "operator user"


  Background:
    Given the user is authenticated
    And the user navigates to the "Operator User" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Operator User"
