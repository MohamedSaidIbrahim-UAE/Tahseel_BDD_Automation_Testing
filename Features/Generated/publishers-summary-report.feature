Feature: Publishers Summary Report - Publisher
  ...
  So that I can manage and track publisher


  Background:
    Given the user is authenticated
    And the user navigates to the "Publishers Summary Report" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Publishers Summary Report"
