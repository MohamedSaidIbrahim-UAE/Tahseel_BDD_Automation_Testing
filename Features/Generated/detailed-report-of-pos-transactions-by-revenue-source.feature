# Feature: Detailed Report Of POS Transactions By Revenue Source - Entity
  ...
  Background:
    ...
    And the user navigates to the "Detailed Report Of POS Transactions By Revenue Source" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Detailed Report Of POS Transactions By Revenue Source"
