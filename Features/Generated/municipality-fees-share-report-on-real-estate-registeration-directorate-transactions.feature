# Feature: Municipality Fees Share Report On Real Estate Registeration Directorate Transactions - From Date
  ...
  Background:
    ...
    And the user navigates to the "Municipality Fees Share Report On Real Estate Registeration Directorate Transactions" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Municipality Fees Share Report On Real Estate Registeration Directorate Transactions"
