# Feature: Smart User - Page heading mismatch for "Smart User"
  ...
  So that I can manage and track page heading mismatch for "smart user"


  Background:
    Given the user is authenticated
    And the user navigates to the "Smart User" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Smart User"
