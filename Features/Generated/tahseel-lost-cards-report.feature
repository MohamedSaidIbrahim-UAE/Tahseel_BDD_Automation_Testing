Feature: Tahseel Lost Cards Report - To Date
  ...
  So that I can manage and track to date

  Background:
    Given the user is authenticated
    And the user navigates to the "Tahseel Lost Cards Report" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Tahseel Lost Cards Report"
