# Feature: SFD Detailed Wallets Transactions Report - Wallet Name
  ...
  So that I can manage and track wallet name


  Background:
    Given the user is authenticated
    And the user navigates to the "SFD Detailed Wallets Transactions Report" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "SFD Detailed Wallets Transactions Report"
