# Feature: Refund Transactions - Voucher Details
  ...
  So that I can manage and track voucher details


  Background:
    Given the user is authenticated
    And the user navigates to the "Refund Transactions" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Refund Transactions"
