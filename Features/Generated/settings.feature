# Feature: Settings - Module management and operations
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: English Name, Actions
