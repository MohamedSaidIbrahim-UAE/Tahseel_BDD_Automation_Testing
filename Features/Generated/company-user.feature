# Feature: Company User - Page heading mismatch for "Company User"
  
  As a user
  I want to interact with the Company User module
  So that I can manage and track page heading mismatch for "company user"


  Background:
    Given the user is authenticated
    And the user navigates to the "Company User" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Company User"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: English Name, Username, Actions
