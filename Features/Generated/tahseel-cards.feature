Feature: Tahseel Cards - Page heading mismatch for "Tahseel Cards"
  ...
  So that I can manage and track page heading mismatch for "tahseel cards"

  Background:
    Given the user is authenticated
    And the user navigates to the "Tahseel Cards" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Tahseel Cards"
