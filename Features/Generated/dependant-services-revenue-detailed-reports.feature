# Feature: Dependant Services Revenue Detailed Reports - Entity
  
  As a user
  I want to interact with the Dependant Services Revenue Detailed Reports module
  So that I can manage and track entity


  Background:
    Given the user is authenticated
    And the user navigates to the "Dependant Services Revenue Detailed Reports" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Dependant Services Revenue Detailed Reports"
