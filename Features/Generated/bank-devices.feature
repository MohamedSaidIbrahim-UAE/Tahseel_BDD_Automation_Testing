Feature: Bank Devices - Bank Devices
  ...
  So that I can manage and track bank devices


  Background:
    Given the user is authenticated
    And the user navigates to the "Bank Devices" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Bank Devices"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Device Number, Merchant Number, Device Version
