# Feature: Shared Revenues Between Sharjah Economic Development Department And Sharjah Commerce & Tourism Development Authority - From Date
  ...
  Background:
    ...
    And the user navigates to the "Shared Revenues Between Sharjah Economic Development Department And Sharjah Commerce & Tourism Development Authority" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Shared Revenues Between Sharjah Economic Development Department And Sharjah Commerce & Tourism Development Authority"
