Feature: View Deduct Pending Requests - Module management and operations
  
  As a user
  I want to interact with the View Deduct Pending Requests module
  So that I can manage and track module management and operations


  Background:
    Given the user is authenticated
    And the user navigates to the "View Deduct Pending Requests" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "View Deduct Pending Requests"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Request Number, Company/User Name, Account Number
