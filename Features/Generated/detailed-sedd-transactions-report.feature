# Feature: Detailed SEDD Transactions Report - User
  ...
  So that I can manage and track user


  Background:
    Given the user is authenticated
    And the user navigates to the "Detailed SEDD Transactions Report" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Detailed SEDD Transactions Report"
