Feature: Deposits Details Report - Entity
  
  As a user
  I want to interact with the Deposits Details Report module
  So that I can manage and track entity


  Background:
    Given the user is authenticated
    And the user navigates to the "Deposits Details Report" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Deposits Details Report"
