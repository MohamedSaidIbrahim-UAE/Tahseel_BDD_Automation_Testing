Feature: Voucher Reciept Report - Date From
  ...
  So that I can manage and track date from

  Background:
    Given the user is authenticated
    And the user navigates to the "Voucher Reciept Report" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Voucher Reciept Report"
