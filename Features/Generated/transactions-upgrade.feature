Feature: Transactions Upgrade - Transactions Upgrade
  ...
  So that I can manage and track transactions upgrade

  Background:
    Given the user is authenticated
    And the user navigates to the "Transactions Upgrade" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Transactions Upgrade"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Reference Number, Receipt Number, Booking Date
