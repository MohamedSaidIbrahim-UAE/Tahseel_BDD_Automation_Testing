Feature: Seller Users - Page heading mismatch for "Seller Users"
  ...
  So that I can manage and track page heading mismatch for "seller users"


  Background:
    Given the user is authenticated
    And the user navigates to the "Seller Users" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Seller Users"
