Feature: Detailed Report For Granted Cards Transactions In Book Fair - From Date
  ...
  Background:
    ...
    And the user navigates to the "Detailed Report For Granted Cards Transactions In Book Fair" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Detailed Report For Granted Cards Transactions In Book Fair"
