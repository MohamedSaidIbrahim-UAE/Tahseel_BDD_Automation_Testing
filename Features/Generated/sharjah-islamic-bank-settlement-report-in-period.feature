Feature: Sharjah Islamic Bank Settlement Report In Period - From Date
  
  As a user
  I want to interact with the Sharjah Islamic Bank Settlement Report In Period module
  So that I can manage and track from date


  Background:
    Given the user is authenticated
    And the user navigates to the "Sharjah Islamic Bank Settlement Report In Period" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Sharjah Islamic Bank Settlement Report In Period"
