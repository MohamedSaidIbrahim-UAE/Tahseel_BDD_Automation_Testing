Feature: Stuck Refund Requests - Stuck Refund Requests
  ...
  So that I can manage and track stuck refund requests


  Background:
    Given the user is authenticated
    And the user navigates to the "Stuck Refund Requests" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Stuck Refund Requests"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Request Number, Account Number, English Name
