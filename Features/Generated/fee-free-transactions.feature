Feature: Fee Free Transactions - Page heading mismatch for "Fee-free transactions"
  ...
  So that I can manage and track page heading mismatch for "fee-free transactions"


  Background:
    Given the user is authenticated
    And the user navigates to the "Fee Free Transactions" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Fee Free Transactions"
