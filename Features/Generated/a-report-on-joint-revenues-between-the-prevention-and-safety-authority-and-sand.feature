Feature: A Report On Joint Revenues Between The Prevention And Safety Authority And SAND - From Date
  ...
  Background:
    ...
    And the user navigates to the "A Report On Joint Revenues Between The Prevention And Safety Authority And SAND" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "A Report On Joint Revenues Between The Prevention And Safety Authority And SAND"
