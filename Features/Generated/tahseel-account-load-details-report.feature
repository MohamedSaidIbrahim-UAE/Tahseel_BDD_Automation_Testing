Feature: Tahseel Account Load Details Report - Group
  ...
  So that I can manage and track group


  Background:
    Given the user is authenticated
    And the user navigates to the "Tahseel Account Load Details Report" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Tahseel Account Load Details Report"
