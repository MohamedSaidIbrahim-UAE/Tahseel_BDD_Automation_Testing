Feature: Entities Deposits Summary Report - Deposit Entity
  ...
  So that I can manage and track deposit entity

  Background:
    Given the user is authenticated
    And the user navigates to the "Entities Deposits Summary Report" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Entities Deposits Summary Report"
