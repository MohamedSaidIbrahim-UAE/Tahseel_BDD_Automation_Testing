Feature: Direct Dept Detailed Report - From Date
  
  As a user
  I want to interact with the Direct Dept Detailed Report module
  So that I can manage and track from date


  Background:
    Given the user is authenticated
    And the user navigates to the "Direct Dept Detailed Report" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Direct Dept Detailed Report"
