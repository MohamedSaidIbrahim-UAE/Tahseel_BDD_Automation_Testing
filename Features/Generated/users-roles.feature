Feature: Users Roles - Page heading mismatch for "Users Roles"
  ...
  So that I can manage and track page heading mismatch for "users roles"


  Background:
    Given the user is authenticated
    And the user navigates to the "Users Roles" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Users Roles"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: English Name, Account Profile Type, Active
