Feature: Tahseel Card Transaction Details Reports - Entity
  ...
  Background:
    ...
    And the user navigates to the "Tahseel Card Transaction Details Reports" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Tahseel Card Transaction Details Reports"
