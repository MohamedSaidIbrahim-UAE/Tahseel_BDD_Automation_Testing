Feature: Transaction Audit - From Date
  As a user
  I want to interact with the Transaction Audit module
  So that I can manage and track from date

  Background:
    Given the user is authenticated
    And the user navigates to the "Transaction Audit" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Transaction Audit"
