Feature: Detailed Report Of Smart Reciept Services Fees - Entity
  ...
  Background:
    ...
    And the user navigates to the "Detailed Report Of Smart Reciept Services Fees" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Detailed Report Of Smart Reciept Services Fees"
