Feature: Merchant Users - Page heading mismatch for "Merchant Users"
  ...
  So that I can manage and track page heading mismatch for "merchant users"


  Background:
    Given the user is authenticated
    And the user navigates to the "Merchant Users" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Merchant Users"
