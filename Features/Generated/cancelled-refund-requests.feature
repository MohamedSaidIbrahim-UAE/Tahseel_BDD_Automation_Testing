Feature: Cancelled Refund Requests - Inquire Refund Requests
  ...
  So that I can manage and track inquire refund requests


  Background:
    Given the user is authenticated
    And the user navigates to the "Cancelled Refund Requests" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Cancelled Refund Requests"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Request Send Date, Department, Status
