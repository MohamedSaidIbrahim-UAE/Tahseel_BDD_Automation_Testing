Feature: New Deduct Request - Module management and operations
  As a user
  I want to interact with the New Deduct Request module
  So that I can manage and track module management and operations

  Background:
    Given the user is authenticated
    And the user navigates to the "New Deduct Request" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "New Deduct Request"
