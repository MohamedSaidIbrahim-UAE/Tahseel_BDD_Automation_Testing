# Feature: Merge Cheques - Module management and operations
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Cheque Number, Cheque Number, Cheque Claim Date
