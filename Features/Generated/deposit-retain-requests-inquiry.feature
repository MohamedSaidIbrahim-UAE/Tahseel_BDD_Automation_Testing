# Feature: Deposit Retain Requests Inquiry - Page heading mismatch for "Deposit Retain Requests Inquiry"
  ...
  So that I can manage and track page heading mismatch for "deposit retain requests inquiry"


  Background:
    Given the user is authenticated
    And the user navigates to the "Deposit Retain Requests Inquiry" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Deposit Retain Requests Inquiry"
