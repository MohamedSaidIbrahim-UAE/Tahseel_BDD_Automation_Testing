Feature: Summary GITFees Report For Smart Reciept - Entity
  ...
  Background:
    ...
    And the user navigates to the "Summary GITFees Report For Smart Reciept" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Summary GITFees Report For Smart Reciept"
