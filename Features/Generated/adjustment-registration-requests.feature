Feature: Adjustment Registration Requests - Page heading mismatch for "Adjustment Registration Requests"
  As a user
  I want to interact with the Adjustment Registration Requests module
  So that I can manage and track page heading mismatch for "adjustment registration requests"

  Background:
    Given the user is authenticated
    And the user navigates to the "Adjustment Registration Requests" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Adjustment Registration Requests"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Reference Number, Department, Sub-Department
