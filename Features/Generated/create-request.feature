Feature: Create Request - Page heading mismatch for "Create Request"
  ...
  So that I can manage and track page heading mismatch for "create request"

  Background:
    Given the user is authenticated
    And the user navigates to the "Create Request" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Create Request"
