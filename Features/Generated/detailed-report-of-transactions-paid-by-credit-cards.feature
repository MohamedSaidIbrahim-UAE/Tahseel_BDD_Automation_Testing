Feature: Detailed Report Of Transactions Paid By Credit Cards - Entity
  ...
  Background:
    ...
    And the user navigates to the "Detailed Report Of Transactions Paid By Credit Cards" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Detailed Report Of Transactions Paid By Credit Cards"
