Feature: Government User - Page heading mismatch for "Government User"
  ...
  So that I can manage and track page heading mismatch for "government user"

  Background:
    Given the user is authenticated
    And the user navigates to the "Government User" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Government User"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: English Name, Username, User Role Type
