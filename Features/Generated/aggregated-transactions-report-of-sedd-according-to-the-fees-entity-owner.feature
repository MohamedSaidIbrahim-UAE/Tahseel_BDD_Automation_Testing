Feature: Aggregated Transactions Report Of SEDD According To The Fees Entity Owner - DepCode
  ...
  So that I can manage and track depcode

  Background:
    Given the user is authenticated
    And the user navigates to the "Aggregated Transactions Report Of SEDD According To The Fees Entity Owner" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Aggregated Transactions Report Of SEDD According To The Fees Entity Owner"
