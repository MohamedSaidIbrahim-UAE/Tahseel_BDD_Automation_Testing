Feature: Pending Deposit Refund Requests - Page heading mismatch for "Pending Deposit Refund Requests"
  ...
  So that I can manage and track page heading mismatch for "pending deposit refund requests"

  Background:
    Given the user is authenticated
    And the user navigates to the "Pending Deposit Refund Requests" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Pending Deposit Refund Requests"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Creation Date, Reference Number, Reciept Number
