Feature: Cheques Transactions - Module management and operations
  
  As a user
  I want to interact with the Cheques Transactions module
  So that I can manage and track module management and operations


  Background:
    Given the user is authenticated
    And the user navigates to the "Cheques Transactions" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Cheques Transactions"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Department, Transaction No, Reference Number
