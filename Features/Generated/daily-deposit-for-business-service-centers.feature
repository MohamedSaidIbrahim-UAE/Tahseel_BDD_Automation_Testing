Feature: Daily Deposit For Business Service Centers - Daily deposit for Business Service Centers
  ...
  So that I can manage and track daily deposit for business service centers


  Background:
    Given the user is authenticated
    And the user navigates to the "Daily Deposit For Business Service Centers" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Daily Deposit For Business Service Centers"
