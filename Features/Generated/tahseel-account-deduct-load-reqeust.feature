Feature: Tahseel Account Deduct & Load Reqeust - Request type
  ...
  So that I can manage and track request type

  Background:
    Given the user is authenticated
    And the user navigates to the "Tahseel Account Deduct & Load Reqeust" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Tahseel Account Deduct & Load Reqeust"
