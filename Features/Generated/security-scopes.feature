Feature: Security Scopes - Page heading mismatch for "Security Scopes"
  ...
  So that I can manage and track page heading mismatch for "security scopes"


  Background:
    Given the user is authenticated
    And the user navigates to the "Security Scopes" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Security Scopes"
