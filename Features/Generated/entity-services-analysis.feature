Feature: Entity Services Analysis - Page heading mismatch for "Entity Services Analysis"
  ...
  So that I can manage and track page heading mismatch for "entity services analysis"

  Background:
    Given the user is authenticated
    And the user navigates to the "Entity Services Analysis" module
  # POSITIVE SCENARIOS

  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Entity Services Analysis"
