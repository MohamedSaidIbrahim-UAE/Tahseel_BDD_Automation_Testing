# Feature: Pre Authorized Transaction Workflow - Page heading mismatch for "Pre-Authorized Transaction Workflow"
  ...
  So that I can manage and track page heading mismatch for "pre-authorized transaction workflow"


  Background:
    Given the user is authenticated
    And the user navigates to the "Pre Authorized Transaction Workflow" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Pre Authorized Transaction Workflow"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: English Name, Entity, Active
