Feature: Shared Revenues Between The Directorate Of Town Planning And Survey And Sharjah Municipality - From Date
  ...
  Background:
    ...
    And the user navigates to the "Shared Revenues Between The Directorate Of Town Planning And Survey And Sharjah Municipality" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Shared Revenues Between The Directorate Of Town Planning And Survey And Sharjah Municipality"
