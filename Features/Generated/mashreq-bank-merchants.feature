Feature: Mashreq Bank Merchants - Module management and operations
  ...
  Background:
    ...
    And the user navigates to the "Mashreq Bank Merchants" module

  # POSITIVE SCENARIOS
  Scenario: Load module page successfully
    When the user opens the module
    Then the module page should load
    And the page title should display "Mashreq Bank Merchants"
  ...
  Scenario: View data in table
    ...
    Then the table should display the following columns: Merchant Number, Bank, Bank Channel
